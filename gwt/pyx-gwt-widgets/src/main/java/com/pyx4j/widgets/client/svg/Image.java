...
public class Image extends GraphicsElement {
    ...
    public Image(String url, Coordinate coordinate, String width, String height) {
        setElement(SvgDOM.createElementNS(SvgDOM.SVG_NAMESPACE, "image"));
        ...
        SvgDOM.setAttributeNS("http://www.w3.org/1999/xlink", getElement(), "xlink:href", url);
    }
