...
public class GrayPalette extends Palette {

    public GrayPalette() {
        putThemeColor(ThemeColors.OBJECT_TONE1, 0x404040);
        putThemeColor(ThemeColors.OBJECT_TONE2, 0x404040);
        putThemeColor(ThemeColors.OBJECT_TONE3, 0x303030);
        putThemeColor(ThemeColors.OBJECT_TONE4, 0x505050);
        putThemeColor(ThemeColors.OBJECT_TONE5, 0x387CBB);
        putThemeColor(ThemeColors.BORDER, 0xffffff);
        putThemeColor(ThemeColors.SELECTION, 0xffa500);
        putThemeColor(ThemeColors.SELECTION_TEXT, 0x000000);
        putThemeColor(ThemeColors.TEXT_BACKGROUND, 0x000000);
        putThemeColor(ThemeColors.TEXT, 0xffffff);
