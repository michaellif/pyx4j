 ...
 */
public class Dialog_v2 implements ProvidesResize {

    private static final Logger log = LoggerFactory.getLogger(Dialog_v2.class);
    ...
    private static final List<Dialog_v2> openDialogs = new Vector<Dialog_v2>();

    private int dialogPixelWidth;

    public Dialog_v2(String caption) {
        this(caption, null, null);
    }

    public Dialog_v2(String caption, DialogOptions options, IsWidget body) {
        super();
    ...
    public void hide(boolean autoClosed) {
        ...
        if (openDialogs.size() > 0) {
            final Dialog_v2 d = openDialogs.get(openDialogs.size() - 1);
