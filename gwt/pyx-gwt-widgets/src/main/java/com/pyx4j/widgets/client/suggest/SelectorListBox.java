...
//
//public class SelectorListBox<E> extends AbstractSelectorWidget<Collection<E>> implements HasSelectionHandlers<E>, IFocusWidget, WatermarkComponent {
//
//    private Collection<E> value;
//
