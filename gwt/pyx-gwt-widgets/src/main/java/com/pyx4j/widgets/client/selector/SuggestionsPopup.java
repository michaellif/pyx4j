...
import com.pyx4j.widgets.client.selector.SuggestiveSelector.Styles;

public class SuggestionsPopup<DataType> extends PopupPanel {

    private static final I18n i18n = I18n.get(SuggestionsPopup.class);

    private final SuggestiveSelector<DataType> parentSelector;
    ...
    public SuggestionsPopup(SuggestiveSelector<DataType> superSuggestiveSelector) {
        ...
        suggestionList.setPageSize(SuggestiveSelector.SUGGESTIONS_PER_PAGE);
