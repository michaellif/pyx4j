...
public class CMoneyField_New extends CTextFieldBase<BigDecimal, NTextBox<BigDecimal>> {

    private static final I18n i18n = I18n.get(CMoneyField_New.class);

    public CMoneyField_New() {
        super();
