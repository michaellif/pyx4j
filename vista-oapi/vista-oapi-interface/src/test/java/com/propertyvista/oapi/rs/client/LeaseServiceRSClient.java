 ...
 * @version $Id$
 */
package com.propertyvista.oapi.rs.client;
...
public class LeaseServiceRSClient {
    ...
    public static void createLease(String leaseId, String buildingCode, String tenantId, String unitNumber) throws MalformedURLException {
        ...
        URL url = null;
        if (isLocal) {
            url = new URL("http://localhost:8888/vista/interfaces/oapi/rs/leases/updateLease");
        } else {
            url = new URL("http://static-11.birchwoodsoftwaregroup.com/interfaces/oapi/rs/leases/updateLease");
        }
