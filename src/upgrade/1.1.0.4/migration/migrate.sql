...
***     ======================================================================================================================
***
***             @version $Revision: 12740 $ ($Author: akinareevski $) $Date: 2013-05-17 23:39:57 -0400 (Fri, 17 May 2013) $
***
***             1.1.0.4 migration
***
***     ======================================================================================================================
...
BEGIN TRANSACTION;
        SELECT  namespace,_dba_.migrate_pmc_1104(namespace)
        FROM    _admin_.admin_pmc a
        JOIN    pg_namespace n ON (a.namespace = n.nspname)
        WHERE   status != 'Created'
        AND     schema_version != '1.1.0.4'
        AND     namespace ~ '^a';
COMMIT;
...
DROP FUNCTION _dba_.migrate_pmc_1104(text);
