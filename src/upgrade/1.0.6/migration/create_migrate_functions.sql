...
BEGIN
        ...
        **/
        ...
        ALTER TABLE billing_account ADD CONSTRAINT billing_account_payment_accepted_e_ck CHECK ((payment_accepted) IN ('Any', 'CashEquivalent', 'DoNotAccept'));
