 ...
 ALTER TABLE legal_documentation$co_application ADD CONSTRAINT legal_documentation$co_application_owner_fk FOREIGN KEY(owner) REFERENCES legal_documentation(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE legal_documentation$co_application ADD CONSTRAINT legal_documentation$co_application_value_fk FOREIGN KEY(value) REFERENCES legal_terms_descriptor(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE legal_documentation$guarantor_application ADD CONSTRAINT legal_documentation$guarantor_application_owner_fk FOREIGN KEY(owner) REFERENCES legal_documentation(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE legal_documentation$guarantor_application ADD CONSTRAINT legal_documentation$guarantor_application_value_fk FOREIGN KEY(value) REFERENCES legal_terms_descriptor(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE legal_documentation$main_application ADD CONSTRAINT legal_documentation$main_application_owner_fk FOREIGN KEY(owner) REFERENCES legal_documentation(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE legal_documentation$main_application ADD CONSTRAINT legal_documentation$main_application_value_fk FOREIGN KEY(value) REFERENCES legal_terms_descriptor(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE legal_documentation$payment_authorization ADD CONSTRAINT legal_documentation$payment_authorization_owner_fk FOREIGN KEY(owner) REFERENCES legal_documentation(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE legal_documentation$payment_authorization ADD CONSTRAINT legal_documentation$payment_authorization_value_fk FOREIGN KEY(value) REFERENCES legal_terms_descriptor(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE maintenance_request_category$sub_categories ADD CONSTRAINT maintenance_request_category$sub_categories_owner_fk FOREIGN KEY(owner) REFERENCES maintenance_request_category(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE maintenance_request_category$sub_categories ADD CONSTRAINT maintenance_request_category$sub_categories_value_fk FOREIGN KEY(value) REFERENCES maintenance_request_category(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE online_application ADD CONSTRAINT online_application_master_online_application_fk FOREIGN KEY(master_online_application) REFERENCES master_online_application(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE organization_contacts$contact_list ADD CONSTRAINT organization_contacts$contact_list_owner_fk FOREIGN KEY(owner) REFERENCES organization_contacts(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE organization_contacts$contact_list ADD CONSTRAINT organization_contacts$contact_list_value_fk FOREIGN KEY(value) REFERENCES organization_contact(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE payment_information ADD CONSTRAINT payment_information_payment_method_billing_address_country_fk FOREIGN KEY(payment_method_billing_address_country) REFERENCES country(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE payment_information ADD CONSTRAINT payment_information_payment_method_billing_address_province_fk FOREIGN KEY(payment_method_billing_address_province) REFERENCES province(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE payment_information ADD CONSTRAINT payment_information_payment_method_details_fk FOREIGN KEY(payment_method_details) REFERENCES payment_payment_details(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE payment_record_processing ADD CONSTRAINT payment_record_processing_aggregated_transfer_fk FOREIGN KEY(aggregated_transfer) REFERENCES aggregated_transfer(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE payment_record_processing ADD CONSTRAINT payment_record_processing_payment_record_fk FOREIGN KEY(payment_record) REFERENCES payment_record(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE payment_transaction_account$allowed_transaction ADD CONSTRAINT payment_transaction_account$allowed_transaction_owner_fk FOREIGN KEY(owner) REFERENCES payment_transaction_account(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE payment_transactions_policy$policy_items ADD CONSTRAINT payment_transactions_policy$policy_items_owner_fk FOREIGN KEY(owner) REFERENCES payment_transactions_policy(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE payment_transactions_policy$policy_items ADD CONSTRAINT payment_transactions_policy$policy_items_value_fk FOREIGN KEY(value) REFERENCES payment_transaction_account(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE resident_portal_settings$custom_html ADD CONSTRAINT resident_portal_settings$custom_html_owner_fk FOREIGN KEY(owner) REFERENCES resident_portal_settings(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE resident_portal_settings$custom_html ADD CONSTRAINT resident_portal_settings$custom_html_value_fk FOREIGN KEY(value) REFERENCES html_content(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE resident_portal_settings$proxy_whitelist ADD CONSTRAINT resident_portal_settings$proxy_whitelist_owner_fk FOREIGN KEY(owner) REFERENCES resident_portal_settings(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE site_descriptor$home_page_gadgets_narrow ADD CONSTRAINT site_descriptor$home_page_gadgets_narrow_owner_fk FOREIGN KEY(owner) REFERENCES site_descriptor(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE site_descriptor$home_page_gadgets_narrow ADD CONSTRAINT site_descriptor$home_page_gadgets_narrow_value_fk FOREIGN KEY(value) REFERENCES home_page_gadget(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE site_descriptor$home_page_gadgets_wide ADD CONSTRAINT site_descriptor$home_page_gadgets_wide_owner_fk FOREIGN KEY(owner) REFERENCES site_descriptor(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE site_descriptor$home_page_gadgets_wide ADD CONSTRAINT site_descriptor$home_page_gadgets_wide_value_fk FOREIGN KEY(value) REFERENCES home_page_gadget(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE site_descriptor ADD CONSTRAINT site_descriptor_resident_portal_settings_fk FOREIGN KEY(resident_portal_settings) REFERENCES resident_portal_settings(id)  DEFERRABLE INITIALLY DEFERRED;
