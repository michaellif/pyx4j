...
BEGIN
 ...
 ALTER TABLE billing_arrears_snapshot$aging_buckets ADD CONSTRAINT billing_arrears_snapshot$aging_buckets_owner_fk FOREIGN KEY(owner) REFERENCES billing_arrears_snapshot(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE billing_billing_cycle_stats ADD CONSTRAINT billing_billing_cycle_stats_billing_cycle_fk FOREIGN KEY(billing_cycle) REFERENCES billing_billing_cycle(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE billing_invoice_line_item ADD CONSTRAINT billing_invoice_line_item_product_charge_fk FOREIGN KEY(product_charge) REFERENCES billing_invoice_line_item(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE buildingcontacts$organization_contacts ADD CONSTRAINT buildingcontacts$organization_contacts_value_fk FOREIGN KEY(value) REFERENCES organization_contact(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE customer_credit_check ADD CONSTRAINT customer_credit_check_background_check_policy_fk FOREIGN KEY(background_check_policy) REFERENCES background_check_policy_v(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE customer_screening_income_info ADD CONSTRAINT customer_screening_income_info_address_province_fk FOREIGN KEY(address_province) REFERENCES province(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE customer_screening_v ADD CONSTRAINT customer_screening_v_legal_questions_fk FOREIGN KEY(legal_questions) REFERENCES customer_screening_legal_questions(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE deposit_lifecycle$interest_adjustments ADD CONSTRAINT deposit_lifecycle$interest_adjustments_owner_fk FOREIGN KEY(owner) REFERENCES deposit_lifecycle(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE deposit_lifecycle$interest_adjustments ADD CONSTRAINT deposit_lifecycle$interest_adjustments_value_fk FOREIGN KEY(value) REFERENCES deposit_interest_adjustment(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE identification_document_type ADD CONSTRAINT identification_document_type_policy_fk FOREIGN KEY(policy) REFERENCES application_documentation_policy(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE insurance_tenant_sure_transaction ADD CONSTRAINT insurance_tenant_sure_transaction_insurance_fk FOREIGN KEY(insurance) REFERENCES insurance_certificate(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE insurance_tenant_sure_transaction ADD CONSTRAINT insurance_tenant_sure_transaction_payment_method_fk FOREIGN KEY(payment_method) REFERENCES payment_method(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE invoice_adjustment_sub_line_item ADD CONSTRAINT invoice_adjustment_sub_line_item_billable_item_adjustment_fk FOREIGN KEY(billable_item_adjustment) REFERENCES billable_item_adjustment(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE invoice_adjustment_sub_line_item ADD CONSTRAINT invoice_adjustment_sub_line_item_line_item_fk FOREIGN KEY(line_item) REFERENCES billing_invoice_line_item(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE invoice_concession_sub_line_item ADD CONSTRAINT invoice_concession_sub_line_item_line_item_fk FOREIGN KEY(line_item) REFERENCES billing_invoice_line_item(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE lease_adjustment_policy_item$taxes ADD CONSTRAINT lease_adjustment_policy_item$taxes_owner_fk FOREIGN KEY(owner) REFERENCES lease_adjustment_policy_item(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE lease_billing_type_policy_item ADD CONSTRAINT lease_billing_type_policy_item_lease_billing_policy_fk FOREIGN KEY(lease_billing_policy) REFERENCES lease_billing_policy(id)  DEFERRABLE INITIALLY DEFERRED;
 ...
 ALTER TABLE lease_term_vlease_products$feature_items ADD CONSTRAINT lease_term_vlease_products$feature_items_owner_fk FOREIGN KEY(owner) REFERENCES lease_term_v(id)  DEFERRABLE INITIALLY DEFERRED;
 ALTER TABLE lease_term_vlease_products$feature_items ADD CONSTRAINT lease_term_vlease_products$feature_items_value_fk FOREIGN KEY(value) REFERENCES billable_item(id)  DEFERRABLE INITIALLY DEFERRED;
