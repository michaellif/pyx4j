...
***
***             Greenwin to larlyn insurance move
***
***     ======================================================================================================================
**/
...
BEGIN TRANSACTION;
    ...
    (
        ...
        WHERE   b.property_code IN ('dale0019','dale0021','belm0545',
                'belm0547','belm0565')
    ...
    **/
    ...
    ALTER TABLE larlyn.payment_payment_details ADD COLUMN old_id BIGINT;
    ALTER TABLE larlyn.payment_method ADD COLUMN old_id BIGINT;
    ALTER TABLE larlyn.tenant_sure_insurance_policy_client ADD COLUMN old_id BIGINT;
    
    
    INSERT INTO larlyn.payment_payment_details (id,old_id,id_discriminator,
    ...
    INSERT INTO larlyn.payment_method(id,old_id,tenant,details,id_discriminator,payment_type,
    ...
    JOIN    larlyn.payment_payment_details ppd ON (ppd.old_id = t.details)
    JOIN    larlyn.lease_participant lp ON (lp.participant_id = t.participant_id)
    JOIN    larlyn.province p ON (p.code = t.code)
    JOIN    larlyn.country c ON (c.name = t.name));
    
    ALTER TABLE larlyn.insurance_policy ADD COLUMN old_id BIGINT;
    ALTER TABLE larlyn.insurance_certificate ADD COLUMN old_id BIGINT;
    ALTER TABLE larlyn.insurance_certificate_scan_blob ADD COLUMN old_id BIGINT;
    
    INSERT INTO larlyn.tenant_sure_insurance_policy_client (id,old_id,tenant_discriminator,
    ...
    JOIN    larlyn.lease_participant lp ON (t.participant_id = lp.participant_id));
    
    INSERT INTO larlyn.insurance_policy (id,old_id,tenant,id_discriminator,tenant_discriminator,
    ...
    JOIN    larlyn.lease_participant lp ON (lp.participant_id = t.participant_id)
    LEFT JOIN   larlyn.customer_user cu ON (cu.email = t.email)
    LEFT JOIN   larlyn.tenant_sure_insurance_policy_client ts ON (ts.old_id = t.client));
    
    
    INSERT INTO larlyn.insurance_certificate (id,old_id,id_discriminator,insurance_policy_discriminator,
    ...
    JOIN    larlyn.insurance_policy i ON (i.old_id = t.insurance_policy));
    
    
    INSERT INTO larlyn.insurance_certificate_scan_blob (id,old_id,content_type,
    ...
    INSERT INTO larlyn.insurance_certificate_scan (id,file_file_name,file_updated_timestamp,
    ...
    JOIN    larlyn.insurance_certificate ic ON (ic.old_id = t.certificate)
    JOIN    larlyn.insurance_certificate_scan_blob b ON (b.old_id = t.file_blob_key)); 
    
    INSERT INTO larlyn.tenant_sure_transaction(id,insurance_discriminator,
    ...
    JOIN    larlyn.insurance_policy i ON (i.old_id = t.insurance)
    JOIN    larlyn.payment_method pm ON (pm.old_id = t.payment_method));
    
    INSERT INTO larlyn.tenant_sure_insurance_policy_report(id,insurance_discriminator,
    ...
    WHERE   p.namespace = 'larlyn'
    AND     a.certificate_number IN 
            (SELECT insurance_certificate_number
            FROM    larlyn.insurance_certificate
            WHERE   id_discriminator = 'InsuranceTenantSure');
    
    SET CONSTRAINTS ALL IMMEDIATE;
    
    ALTER TABLE larlyn.insurance_policy DROP COLUMN old_id;
    ALTER TABLE larlyn.insurance_certificate DROP COLUMN old_id;
    ALTER TABLE larlyn.insurance_certificate_scan_blob DROP COLUMN old_id;
    ALTER TABLE larlyn.payment_payment_details DROP COLUMN old_id;
    ALTER TABLE larlyn.payment_method DROP COLUMN old_id;
    ALTER TABLE larlyn.tenant_sure_insurance_policy_client DROP COLUMN old_id;
