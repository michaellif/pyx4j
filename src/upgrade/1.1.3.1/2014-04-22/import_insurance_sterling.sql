...
***
***             Greenwin to sterling insurance move
***
***     ======================================================================================================================
**/
...
BEGIN TRANSACTION;
    ...
    **/
    ...
    ALTER TABLE sterling.payment_payment_details ADD COLUMN old_id BIGINT;
    ALTER TABLE sterling.payment_method ADD COLUMN old_id BIGINT;
    ALTER TABLE sterling.tenant_sure_insurance_policy_client ADD COLUMN old_id BIGINT;
    
    
    INSERT INTO sterling.payment_payment_details (id,old_id,id_discriminator,
    ...
    INSERT INTO sterling.payment_method(id,old_id,tenant,details,id_discriminator,payment_type,
    ...
    JOIN    sterling.payment_payment_details ppd ON (ppd.old_id = t.details)
    JOIN    sterling.lease_participant lp ON (lp.participant_id = t.participant_id)
    JOIN    sterling.province p ON (p.code = t.code)
    JOIN    sterling.country c ON (c.name = t.name));
    
    ALTER TABLE sterling.insurance_policy ADD COLUMN old_id BIGINT;
    ALTER TABLE sterling.insurance_certificate ADD COLUMN old_id BIGINT;
    ALTER TABLE sterling.insurance_certificate_scan_blob ADD COLUMN old_id BIGINT;
    
    INSERT INTO sterling.tenant_sure_insurance_policy_client (id,old_id,tenant_discriminator,
    ...
    JOIN    sterling.lease_participant lp ON (t.participant_id = lp.participant_id));
    
    INSERT INTO sterling.insurance_policy (id,old_id,tenant,id_discriminator,tenant_discriminator,
    ...
    JOIN    sterling.lease_participant lp ON (lp.participant_id = t.participant_id)
    LEFT JOIN   sterling.customer_user cu ON (cu.email = t.email)
    LEFT JOIN   sterling.tenant_sure_insurance_policy_client ts ON (ts.old_id = t.client));
    
    
    INSERT INTO sterling.insurance_certificate (id,old_id,id_discriminator,insurance_policy_discriminator,
    ...
    JOIN    sterling.insurance_policy i ON (i.old_id = t.insurance_policy));
    
    
    INSERT INTO sterling.insurance_certificate_scan_blob (id,old_id,content_type,
    ...
    INSERT INTO sterling.insurance_certificate_scan (id,file_file_name,file_updated_timestamp,
    ...
    JOIN    sterling.insurance_certificate ic ON (ic.old_id = t.certificate)
    JOIN    sterling.insurance_certificate_scan_blob b ON (b.old_id = t.file_blob_key)); 
    
    INSERT INTO sterling.tenant_sure_transaction(id,insurance_discriminator,
    ...
    JOIN    sterling.insurance_policy i ON (i.old_id = t.insurance)
    JOIN    sterling.payment_method pm ON (pm.old_id = t.payment_method));
    
    INSERT INTO sterling.tenant_sure_insurance_policy_report(id,insurance_discriminator,
    ...
    ALTER TABLE sterling.insurance_policy DROP COLUMN old_id;
    ALTER TABLE sterling.insurance_certificate DROP COLUMN old_id;
    ALTER TABLE sterling.insurance_certificate_scan_blob DROP COLUMN old_id;
    ALTER TABLE sterling.payment_payment_details DROP COLUMN old_id;
    ALTER TABLE sterling.payment_method DROP COLUMN old_id;
    ALTER TABLE sterling.tenant_sure_insurance_policy_client DROP COLUMN old_id;
