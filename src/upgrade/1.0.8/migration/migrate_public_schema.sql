...
BEGIN TRANSACTION;
 ...
 CREATE SEQUENCE lease_participant$preauthorized_payments_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
 ...
 ALTER SEQUENCE lease_participant$preauthorized_payments_seq OWNER TO vista ;
