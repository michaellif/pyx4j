...
BEGIN TRANSACTION;
    ...
    CREATE SEQUENCE customer_preferences_portal_hidable_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
    CREATE SEQUENCE customer_preferences_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
    ...
    ALTER SEQUENCE customer_preferences_portal_hidable_seq OWNER TO vista ;
    ALTER SEQUENCE customer_preferences_seq OWNER TO vista ;
