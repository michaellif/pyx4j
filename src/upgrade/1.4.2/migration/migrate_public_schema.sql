...
BEGIN TRANSACTION;
    ...
    CREATE SEQUENCE communication_episode_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
    ...
    CREATE SEQUENCE eviction_status_record$attachments_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
    ...
    ALTER SEQUENCE communication_episode_seq OWNER TO vista ;
    ...
    ALTER SEQUENCE eviction_status_record$attachments_seq OWNER TO vista ;
