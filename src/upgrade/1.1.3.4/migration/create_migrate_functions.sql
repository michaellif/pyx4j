...
***
***             version 1.1.3.4 PMC migration function
***
***     ======================================================================================================================
**/

CREATE OR REPLACE FUNCTION _dba_.migrate_pmc_1134(v_schema_name TEXT) RETURNS VOID AS
$$
BEGIN
        ...
        **/
        ...
        ALTER TABLE merchant_account ADD COLUMN setup_accepted_credit_card_visa_debit BOOLEAN;
        ...
        **/
        ...
        EXECUTE 'UPDATE '||v_schema_name||'.merchant_account '
                ||'SET  setup_accepted_credit_card_visa_debit = TRUE ';
