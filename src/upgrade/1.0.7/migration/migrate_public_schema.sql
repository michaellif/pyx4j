...
BEGIN TRANSACTION;
 ...
 CREATE SEQUENCE payment_method_selection_policy_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
 ...
 ALTER SEQUENCE payment_method_selection_policy_seq OWNER TO vista ;
