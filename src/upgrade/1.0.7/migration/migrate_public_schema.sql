...
BEGIN TRANSACTION;
 ...
 CREATE SEQUENCE resident_portal_settings$proxy_html_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
 ...
 ALTER SEQUENCE resident_portal_settings$proxy_html_seq OWNER TO vista ;
