...
BEGIN TRANSACTION;
        ...
        CREATE SEQUENCE n4_policy$relevant_arcodes_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        ALTER SEQUENCE n4_policy$relevant_arcodes_seq OWNER TO vista ;
