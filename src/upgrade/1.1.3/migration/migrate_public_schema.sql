...
BEGIN TRANSACTION;
        ...
        DROP SEQUENCE campaign$audience_seq;
        DROP SEQUENCE campaign$media_seq;
        DROP SEQUENCE campaign$schedule_seq;
        DROP SEQUENCE campaign_seq;
        DROP SEQUENCE charges_seq;
        DROP SEQUENCE communication_media_seq;
        DROP SEQUENCE communication_person_seq;
        ...
        DROP SEQUENCE recipient$contact_list_seq;
        DROP SEQUENCE recipient_seq;
        ...
        CREATE SEQUENCE communication_message$to_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        CREATE SEQUENCE communication_message_attachment_blob_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        CREATE SEQUENCE communication_message_attachment_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        CREATE SEQUENCE communication_thread_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        CREATE SEQUENCE lease_application_document_blob_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        CREATE SEQUENCE lease_application_document_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        CREATE SEQUENCE lease_term$agreement_confirmation_terms_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        CREATE SEQUENCE lease_term$agreement_legal_terms_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        CREATE SEQUENCE proof_of_income_document_blob_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        CREATE SEQUENCE proof_of_income_document_file_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        CREATE SEQUENCE proof_of_income_document_folder_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        CREATE SEQUENCE system_endpoint_seq START WITH 1 INCREMENT BY 1 NO MAXVALUE NO MINVALUE CACHE 1;
        ...
        ALTER SEQUENCE communication_message$to_seq OWNER TO vista ;
        ALTER SEQUENCE communication_message_attachment_blob_seq OWNER TO vista ;
        ALTER SEQUENCE communication_message_attachment_seq OWNER TO vista ;
        ALTER SEQUENCE communication_thread_seq OWNER TO vista ;
        ...
        ALTER SEQUENCE lease_application_document_blob_seq OWNER TO vista ;
        ALTER SEQUENCE lease_application_document_seq OWNER TO vista ;
        ...
        ALTER SEQUENCE lease_term$agreement_confirmation_terms_seq OWNER TO vista ;
        ...
        ALTER SEQUENCE lease_term$agreement_legal_terms_seq OWNER TO vista ;
        ...
        ALTER SEQUENCE proof_of_income_document_blob_seq OWNER TO vista ;
        ALTER SEQUENCE proof_of_income_document_file_seq OWNER TO vista ;
        ALTER SEQUENCE proof_of_income_document_folder_seq OWNER TO vista ;
        ...
        ALTER SEQUENCE system_endpoint_seq OWNER TO vista ;
