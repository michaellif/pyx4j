...
//            YardiServiceUtils.getResidentTransactions(c, yp, yp.getYardiPropertyId());
//
...
//
//        YardiServiceUtils.importResidentTransactions(c, yp);
//
//    }
//
...
//        YardiServiceUtils.getResidentTransactionsByChargeDate(c, yp);
//        YardiServiceUtils.getResidentTransactionsByApplicationDate(c, yp);
//        YardiServiceUtils.getResidentsLeaseCharges(c, yp);
////    YardiTransactions.getResidentLeaseCharges(c, yp);
//        //       YardiTransactions.getUnitInformationLogin(c, yp);
//        YardiServiceUtils.getVendors(c, yp);
//        YardiServiceUtils.getExportChartOfAccounts(c, yp);
//        YardiServiceUtils.getPropertyConfigurations(c, yp);
//    }
}
