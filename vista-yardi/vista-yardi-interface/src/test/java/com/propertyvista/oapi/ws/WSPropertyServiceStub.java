...
public class WSPropertyServiceStub extends Service {
    ...
    private final static QName IMPL_SERVICE_QNAME = new QName("http://ws.oapi.propertyvista.com/", "WSPropertyServiceImplService");

    private final static QName IMPL_PORT_QNAME = new QName("http://ws.oapi.propertyvista.com/", "WSPropertyServiceImplPort");
