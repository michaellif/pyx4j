 ...
 * are recorded. These methods can be used directly: <code>Assert.assertEquals(...)</code>, however, they read better if they
...
public class Assert {
     ...
     * <code>actual</code> are <code>null</code>,
    ...
    /**
     * Asserts that two objects are <b>not</b> equals. If they are, an {@link AssertionError} is thrown with the given message. If <code>first</code> and
     * <code>second</code> are <code>null</code>,
     * they are considered equal.
     *
     * @param message
     *            the identifying message for the {@link AssertionError} (<code>null</code> okay)
    ...
    /**
     * Asserts that two objects are <b>not</b> equals. If they are, an {@link AssertionError} without a message is thrown. If <code>first</code> and
     * <code>second</code> are <code>null</code>,
     * they are considered equal.
     *
     * @param first
     ...
     * ignored. NaNs are considered equal: <code>assertNotEquals(Double.NaN, Double.NaN, *)</code> fails
     *
     * @param message
     *            the identifying message for the {@link AssertionError} (<code>null</code> okay)
     * @param first
     ...
     *            the value to check against <code>first</code>
     * @param delta
     *            the maximum delta between <code>expected</code> and <code>actual</code> for which both numbers are still
     *            considered equal.
     */
    ...
    /**
     * Asserts that two object arrays are equal. If they are not, an {@link AssertionError} is thrown with the given message. If <code>expecteds</code> and
     * <code>actuals</code> are <code>null</code>,
     * they are considered equal.
     *
     * @param message
     *            the identifying message for the {@link AssertionError} (<code>null</code> okay)
    ...
    public static void assertArrayEquals(String message, Object[] expecteds, Object[] actuals) throws ArrayComparisonFailure {
        ...
        internalArrayEquals(message, Arrays.asList(expecteds), Arrays.asList(actuals));
    }

    /**
     * Asserts that two object arrays are equal. If they are not, an {@link AssertionError} is thrown. If <code>expected</code> and <code>actual</code> are
     * <code>null</code>, they are considered
     * equal.
     *
     * @param expecteds
     *            Object array or array of arrays (multi-dimensional array) with
    ...
    public static void assertArrayEquals(String message, byte[] expecteds, byte[] actuals) throws ArrayComparisonFailure {
        //internalArrayEquals(message, expecteds, actuals);
        internalArrayEquals(message, Bytes.asList(expecteds), Bytes.asList(actuals));
    }
    ...
    public static void assertArrayEquals(String message, char[] expecteds, char[] actuals) throws ArrayComparisonFailure {
        //internalArrayEquals(message, expecteds, actuals);
        internalArrayEquals(message, Chars.asList(expecteds), Chars.asList(actuals));
    }
    ...
    public static void assertArrayEquals(String message, short[] expecteds, short[] actuals) throws ArrayComparisonFailure {
        //internalArrayEquals(message, expecteds, actuals);
        internalArrayEquals(message, Shorts.asList(expecteds), Shorts.asList(actuals));
    }
    ...
    public static void assertArrayEquals(String message, int[] expecteds, int[] actuals) throws ArrayComparisonFailure {
        //internalArrayEquals(message, expecteds, actuals);
        internalArrayEquals(message, Ints.asList(expecteds), Ints.asList(actuals));
    }
    ...
    public static void assertArrayEquals(String message, long[] expecteds, long[] actuals) throws ArrayComparisonFailure {
        //internalArrayEquals(message, expecteds, actuals);
        internalArrayEquals(message, Longs.asList(expecteds), Longs.asList(actuals));
    }
    ...
    public static void assertArrayEquals(String message, double[] expecteds, double[] actuals, double delta) throws ArrayComparisonFailure {
        ...
        new InexactComparisonCriteria(delta).arrayEquals(null, Doubles.asList(expecteds), Doubles.asList(actuals));
    }
    ...
    public static void assertArrayEquals(String message, float[] expecteds, float[] actuals, float delta) throws ArrayComparisonFailure {
        //new InexactComparisonCriteria(delta).arrayEquals(message, expecteds, actuals);
        new InexactComparisonCriteria(delta).arrayEquals(message, Floats.asList(expecteds), Floats.asList(actuals));
    }
    ...
    private static void internalArrayEquals(String message, List<?> expecteds, List<?> actuals) throws ArrayComparisonFailure {
        new ExactComparisonCriteria().arrayEquals(message, expecteds, actuals);
    }
     ...
     * If they are not, an {@link AssertionError} is thrown with the given
     * message. If the expected value is infinity then the delta value is
     * ignored. NaNs are considered equal: <code>assertEquals(Float.NaN, Float.NaN, *)</code> passes
     *
     * @param message
     *            the identifying message for the {@link AssertionError} (<code>null</code> okay)
     * @param expected
    ...
    /**
     * Asserts that <code>actual</code> satisfies the condition specified by <code>matcher</code>. If not, an {@link AssertionError} is thrown with
