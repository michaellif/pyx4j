...
public class PaymentRecordTester extends Tester {
    ...
    public PaymentRecordTester lastRecordNotice(String message) {
        PaymentRecord lastRecord = lastRecord();
        assertContains(infor() + " Notice on last Record " + lastRecord.getPrimaryKey(), message, lastRecord.notice().getValue());
        return this;
    }
}
