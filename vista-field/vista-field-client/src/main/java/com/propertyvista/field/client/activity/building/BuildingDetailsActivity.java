...
public class BuildingDetailsActivity extends AbstractActivity implements BuildingDetailsView.Presenter {

    private final BuildingDetailsView view;

    public BuildingDetailsActivity() {
        view = BuildingViewFactory.instance(BuildingDetailsView.class);
    }
