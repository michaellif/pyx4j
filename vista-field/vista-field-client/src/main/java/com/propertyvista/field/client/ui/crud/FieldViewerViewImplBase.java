 ...
 * @version $Id$
 */
package com.propertyvista.field.client.ui.crud;
...
public class FieldViewerViewImplBase<E extends IEntity> extends AbstractViewer<E> {

    private static final I18n i18n = I18n.get(FieldViewerViewImplBase.class);
    ...
    public FieldViewerViewImplBase() {
        this(false);
    }

    public FieldViewerViewImplBase(boolean viewOnly) {
...
//                }
    ...
    public FieldViewerViewImplBase(FieldEntityForm<E> form) {
        this(false);
        setForm(form);
    }

    public FieldViewerViewImplBase(FieldEntityForm<E> form, boolean viewOnly) {
        this(viewOnly);
        setForm(form);
    }
