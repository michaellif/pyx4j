...
public class FieldTheme extends VistaTheme {
    ...
    public static enum StyleName implements IStyleName {
        SiteView, SiteViewContent, SiteViewHeader, SiteMainArea, LoginInputField, LoginViewPanel, LoginViewSectionHeader, LoginViewSectionContent, LoginViewSectionFooter, LoginOrLineSeparator, LoginCaption, LoginCaptionText, LoginCaptionTextEmph, LoginButton, LoginButtonHolder, AppSelectionButton, Toolbar, ToolbarImage, ToolbarImageHolder, ToolbarLabel, BuildingLister, BuildingDetails, MenuScreen, AlertsScreen, AlertsScreenContent, AlertsInfo, OverlapScreenNormal, OverlapScreenShiftedLeft, OverlapScreenShiftedRight, SortPanel, SearchPanel, SearchPanelToolbar, SearchResults, Dialog, DialogCaption, DialogResizer, DialogContent, FormFlexPanelH1, FormFlexPanelH1Label, FormFlexPanelH2, FormFlexPanelH2Label, FormFlexPanelH3, FormFlexPanelH3Label, FormFlexPanelH4, FormFlexPanelH4Label, FormFlexPanelActionWidget;
    }
