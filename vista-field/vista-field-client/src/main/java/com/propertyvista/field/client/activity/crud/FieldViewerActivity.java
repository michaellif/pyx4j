 ...
 * @version $Id$
 */
package com.propertyvista.field.client.activity.crud;
...
import com.propertyvista.field.client.event.CrudNavigateEvent;
import com.propertyvista.shared.NotesParentId;

public class FieldViewerActivity<E extends IEntity> extends AbstractViewerActivity<E> {
...
//    private NotesAndAttachmentsVisorController notesAndAttachmentsController;
    ...
    public FieldViewerActivity(CrudAppPlace place, IViewer<E> view, AbstractCrudService<E> service) {
