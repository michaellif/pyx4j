...
import com.propertyvista.field.client.ui.crud.FieldViewerViewImplBase;
import com.propertyvista.field.client.ui.crud.billing.cycle.BillingCycleLister;
import com.propertyvista.field.client.ui.crud.building.catalog.ConcessionLister;
import com.propertyvista.field.client.ui.crud.building.catalog.FeatureLister;
import com.propertyvista.field.client.ui.crud.building.catalog.ServiceLister;
import com.propertyvista.field.client.ui.crud.building.lockers.LockerAreaLister;
import com.propertyvista.field.client.ui.crud.building.mech.BoilerLister;
import com.propertyvista.field.client.ui.crud.building.mech.ElevatorLister;
import com.propertyvista.field.client.ui.crud.building.mech.RoofLister;
import com.propertyvista.field.client.ui.crud.building.parking.ParkingLister;
import com.propertyvista.field.client.ui.crud.floorplan.FloorplanLister;
import com.propertyvista.field.rpc.dto.billing.BillingCycleDTO;

public class BuildingViewerViewImpl extends FieldViewerViewImplBase<BuildingDTO> implements BuildingViewerView {
        ...
        while (dashboardsIterator.hasNext()) {
            ...
            dashboardsMenu.addItem(dashboard.name().getValue(), new Command() {
                ...
                public void execute() {
                    ...
                    if (!isVisorShown()) {
//                        getPresenter().getDashboardController(dashboard, buildingsFilter).show();
                    }
                }
