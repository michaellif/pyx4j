...
public class AlertDetailsViewImpl extends SimplePanel implements AlertDetailsView {

    private final Label alertTextLabel;

    public AlertDetailsViewImpl() {
        setSize("100%", "100%");
        setStyleName(FieldTheme.StyleName.AlertView.name());
    ...
    @Override
    public void setAlertDetails(String alertText) {
