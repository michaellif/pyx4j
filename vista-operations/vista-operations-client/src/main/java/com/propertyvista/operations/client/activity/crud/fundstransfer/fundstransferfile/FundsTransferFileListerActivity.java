...
public class FundsTransferFileListerActivity extends AbstractPrimeListerActivity<FundsTransferFileDTO> {

    public FundsTransferFileListerActivity(AppPlace place) {
