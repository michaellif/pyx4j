...
import com.propertyvista.operations.client.ui.crud.fundstransfer.fundstransferfile.FundsTransferFileViewerView;
...
public class FundsTransferFileViewerActivity extends AbstractViewerActivity<FundsTransferFileDTO> implements PadFileViewerView.Presenter {

    public FundsTransferFileViewerActivity(CrudAppPlace place) {
        super(place, OperationsSite.getViewFactory().getView(FundsTransferFileViewerView.class), GWT
