...
public class PmcFeaturesForm extends CEntityForm<PmcVistaFeatures> {
    ...
    public IsWidget createContent() {
        ...
        content.setWidget(++row, 0, new FormDecoratorBuilder(inject(proto().occupancyModel()), 5).build());
        content.setWidget(++row, 0, new FormDecoratorBuilder(inject(proto().productCatalog()), 5).build());
        ...
        content.setWidget(++row, 0, new FormDecoratorBuilder(inject(proto().defaultProductCatalog()), 5).build());
