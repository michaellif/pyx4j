...
public interface QuickTipListerView extends IPrimeListerView<PortalResidentMarketingTip> {

    interface Presenter extends IPrimeListerView.IPrimeListerPresenter<PortalResidentMarketingTip> {
