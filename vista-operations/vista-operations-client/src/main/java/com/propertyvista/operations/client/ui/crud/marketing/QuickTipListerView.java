...
public interface QuickTipListerView extends IListerView<PortalResidentMarketingTip> {

    interface Presenter extends IListerView.IListerPresenter<PortalResidentMarketingTip> {
