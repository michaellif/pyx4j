...
public interface FundsReconciliationFileViewerView extends IPrimeViewerView<FundsReconciliationFileDTO> {

    FundsReconciliationSummaryLister getSummaryListerView();
}
