...
public interface FundsReconciliationFileViewerView extends IViewer<FundsReconciliationFileDTO> {

    IPrimeLister<FundsReconciliationSummaryDTO> getSummaryListerView();
}
