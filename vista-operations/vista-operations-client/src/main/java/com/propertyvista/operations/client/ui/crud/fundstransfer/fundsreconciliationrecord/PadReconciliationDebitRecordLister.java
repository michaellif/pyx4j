...
public class PadReconciliationDebitRecordLister extends AbstractLister<PadReconciliationDebitRecordDTO> {

    public PadReconciliationDebitRecordLister() {
        super(PadReconciliationDebitRecordDTO.class, false, false);
        setAllowZoomIn(true);
