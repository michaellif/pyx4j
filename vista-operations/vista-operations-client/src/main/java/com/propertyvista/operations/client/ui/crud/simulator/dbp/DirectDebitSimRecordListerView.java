...
public interface DirectDebitSimRecordListerView extends IListerView<DirectDebitSimRecord> {

    interface Presenter extends IListerView.IListerPresenter<DirectDebitSimRecord> {
