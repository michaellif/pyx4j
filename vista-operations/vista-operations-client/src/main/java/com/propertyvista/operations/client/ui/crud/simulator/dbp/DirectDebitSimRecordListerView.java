...
public interface DirectDebitSimRecordListerView extends IPrimeListerView<DirectDebitSimRecord> {

    interface Presenter extends IPrimeListerView.IPrimeListerPresenter<DirectDebitSimRecord> {
