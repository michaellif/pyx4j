...
public interface PadSimFileListerView extends IPrimeListerView<PadSimFile> {

    interface Presenter extends IPrimeListerView.IPrimeListerPresenter<PadSimFile> {
