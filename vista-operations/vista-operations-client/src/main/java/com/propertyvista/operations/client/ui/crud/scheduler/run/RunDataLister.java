...
public class RunDataLister extends ListerBase<RunData> {
    ...
    public RunDataLister() {
        ...
        setColumnDescriptors(//@formatter:off
            ...
            new MemberColumnDescriptor.Builder(proto().executionReport().amountProcessed()).build(),
            new MemberColumnDescriptor.Builder(proto().executionReport().failed()).build(),
            new MemberColumnDescriptor.Builder(proto().executionReport().amountFailed()).build(),
            new MemberColumnDescriptor.Builder(proto().executionReport().erred()).build(),
            new MemberColumnDescriptor.Builder(proto().executionReport().amountErred()).build(),
