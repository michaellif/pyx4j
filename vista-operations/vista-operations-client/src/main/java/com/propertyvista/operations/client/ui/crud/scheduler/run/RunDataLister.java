...
public class RunDataLister extends SiteDataTablePanel<RunData> {

    public RunDataLister(boolean isInlineMode) {
        super(RunData.class, GWT.<AbstractCrudService<RunData>> create(RunDataCrudService.class), false);
