...
public class VistaTermsVersionServiceImpl extends AbstractVistaVersionDataListServiceImpl<VistaTermsV, VistaTermsV> implements VistaTermsVersionService {

    public VistaTermsVersionServiceImpl() {
        super(VistaTermsV.class, VistaTermsV.class, OperationsUser.class);
    }
