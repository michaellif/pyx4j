...
import com.propertyvista.operations.server.onboarding.rhf.RequestHandlerFactory;
...
public class OnboardingRequestHandlerFactory extends RequestHandlerFactory {
    ...
    protected void bind() {
        ...
        bind(ActivatePMCRequestHandler.class);
        bind(CancelPMCRequestHandler.class);
        bind(GetReCaptchaPublicKeyRequestHandler.class);
        bind(GetSatisfactionFastpassUrlHandler.class);
        ...
        bind(ReserveDnsNameRequestHandler.class);
        bind(UpdateBankAccountInfoRequestHandler.class);
        bind(ApproveBankAccountInfoRequestHandler.class);
        bind(GetUsageReportRequestHandler.class);
        bind(UpdatePaymentTypeFeesRequestHandler.class);
        bind(UpdatePmcEquifaxInfoRequestHandler.class);
        bind(GetAccountInfoRequestHandler.class);
    }
}
