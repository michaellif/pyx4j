...
public class JobUtils {
    ...
    public static JobKey getJobKey(com.propertyvista.operations.domain.scheduler.Trigger trigger) {
    ...
    public static TriggerKey getSleepRetryTriggerKey(com.propertyvista.operations.domain.scheduler.Trigger trigger) {
        return new TriggerKey(trigger.getPrimaryKey().toString(), "VistaSleepRetryTrigger");
    }

    public static JobDetail getJobDetail(com.propertyvista.operations.domain.scheduler.Trigger trigger) throws SchedulerException {
        return SchedulerHelper.getScheduler().getJobDetail(getJobKey(trigger));
    }

    public static JobDetail createJobDetail(com.propertyvista.operations.domain.scheduler.Trigger trigger) {
    ...
    public static void schedulSleepRetry(com.propertyvista.operations.domain.scheduler.Trigger trigger, Date executionDate) {
        try {
            JobDetail jobDetail = getJobDetail(trigger);
            if (jobDetail == null) {
                jobDetail = createJobDetail(trigger);
    ...
    public static void updateSchedule(com.propertyvista.operations.domain.scheduler.Trigger origTrigger,
            com.propertyvista.operations.domain.scheduler.Trigger updateTrigger) {
        try {
    ...
    public static void getScheduleDetails(com.propertyvista.operations.domain.scheduler.Trigger trigger) {
