...
public class OneToOneDTOCrudServiceImpl extends AbstractCrudServiceDtoImpl<OneToOneReadOwner, OneToOneReadOwnerDTO> implements OneToOneDTOCrudService {

    public OneToOneDTOCrudServiceImpl() {
