...
public class SummaryStepServiceImpl implements SummaryStepService {
    ...
    @Override
    public void retrieve(AsyncCallback<SummaryStepDTO> callback) {
        SummaryStepDTO entity = EntityFactory.create(SummaryStepDTO.class);
        callback.onSuccess(entity);
    }

    @Override
    public void submit(AsyncCallback<SummaryStepDTO> callback, SummaryStepDTO entity) {
        callback.onSuccess(entity);
    }
