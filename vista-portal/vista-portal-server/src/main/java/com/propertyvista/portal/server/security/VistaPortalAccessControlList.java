...
public class VistaPortalAccessControlList extends ServletContainerAclBuilder {
    ...
    public VistaPortalAccessControlList() {
        ...
        grant(VistaCustomerBehavior.Tenant, new IServiceExecutePermission(com.propertyvista.portal.rpc.portal.web.services.financial.AutoPayService.class));
        ...
        grant(VistaCustomerBehavior.Tenant, new IServiceExecutePermission(
                com.propertyvista.portal.rpc.portal.web.services.financial.AutoPayWizardService.class));
        grant(VistaCustomerBehavior.Tenant, new IServiceExecutePermission(
        ...
        grant(VistaCustomerBehavior.Tenant, new IServiceExecutePermission(ProfileService.class));
