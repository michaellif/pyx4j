...
public class FinancialStepServiceImpl implements FinancialStepService {
    ...
    @Override
    public void retrieve(AsyncCallback<FinancialStepDTO> callback) {
        FinancialStepDTO entity = EntityFactory.create(FinancialStepDTO.class);
        callback.onSuccess(entity);
    }

    @Override
    public void submit(AsyncCallback<FinancialStepDTO> callback, FinancialStepDTO entity) {
        callback.onSuccess(entity);
    }
