 ...
 * @version $Id$
 */
package com.propertyvista.portal.server.preloader.site.blacknight;
...
public class BlackNightSitePreloader extends AbstractSitePreloader {

    @Override
    protected String pmcName() {
        return "BlackNight Property Management UK";
    }
