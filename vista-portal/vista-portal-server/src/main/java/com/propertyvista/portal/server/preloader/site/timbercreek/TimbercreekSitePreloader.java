 ...
 * @version $Id$
 */
package com.propertyvista.portal.server.preloader.site.timbercreek;
...
public class TimbercreekSitePreloader extends AbstractSitePreloader {

    @Override
    protected String pmcName() {
        return "Timbercreek Communities";
    }
