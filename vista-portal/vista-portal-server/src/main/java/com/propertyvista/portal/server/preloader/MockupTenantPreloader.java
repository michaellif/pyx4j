...
//
//                        summary.thisMonth().setValue(new BigDecimal(0));
//                        summary.monthAgo().setValue(new BigDecimal(0));
//                        summary.twoMonthsAgo().setValue(new BigDecimal(0));
//                        summary.threeMonthsAgo().setValue(new BigDecimal(0));
//                        summary.overFourMonthsAgo().setValue(new BigDecimal(0));
//                        summary.totalBalance().setValue(new BigDecimal(0));
//                        summary.arBalance().setValue(new BigDecimal(0));
...
//                + " building arrear statuses for Arrears Gadget";
        ...
        return null; //TODO remove after fixing
    }
