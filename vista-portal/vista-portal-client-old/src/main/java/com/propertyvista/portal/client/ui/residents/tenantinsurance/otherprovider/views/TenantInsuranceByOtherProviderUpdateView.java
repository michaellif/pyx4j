...
public interface TenantInsuranceByOtherProviderUpdateView extends Edit<GeneralInsuranceCertificate> {

    interface Presenter extends Edit.Presenter<GeneralInsuranceCertificate> {
