 ...
 * 
 * requirements.getElement().getStyle().setProperty("background", "url(" +
 * PortalImages.INSTANCE.requirements().getURL() + ") no-repeat");
 ...
 * 
 * time.getElement().getStyle().setProperty("background", "url(" +
 * PortalImages.INSTANCE.time().getURL() + ") no-repeat");
 * leftColumn.add(time);
 * 
 ...
 * 
 * dontWorry.getElement().getStyle().setProperty("background", "url(" +
 * PortalImages.INSTANCE.dontWorry().getURL() + ") no-repeat");
