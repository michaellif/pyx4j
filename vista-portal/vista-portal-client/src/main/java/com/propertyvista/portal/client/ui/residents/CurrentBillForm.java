...
//        container.add(inject(proto().dueDate(), new DueDateViewer()));
...
//    }
    ...
    class DueDateViewer extends CEntityEditor<IEntity> {

        //TODO implement
        public DueDateViewer(Class<IEntity> clazz) {
            super(null);
...
//    class ChargeLineFolder extends CEntityFolderEditor<ChargeLine> {
//
...
//            return new BaseFolderDecorator<ChargeLine>() {
//
//                @Override
//                public void onValueChange(ValueChangeEvent<IList<ChargeLine>> event) {
...
//        }
//
//        private CEntityFolderItemEditor<ChargeLine> createChargeLineViewer() {
//
//            return new CEntityFolderItemEditor<ChargeLine>() {
//
//                @Override
//                public IFolderItemDecorator<ChargeLine> createFolderItemDecorator() {
//                    return new BaseFolderItemDecorator<ChargeLine>() {
//
//                    };
//                }
//
