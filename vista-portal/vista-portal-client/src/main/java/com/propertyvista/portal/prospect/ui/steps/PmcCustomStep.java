...
public class PmcCustomStep extends CPortalEntityWizardStep<PmcCustomStepDTO> {
    ...
    private static final I18n i18n = I18n.get(PmcCustomStep.class);

    private PmcCustomStepPresenter presenter;

    public PmcCustomStep(PmcCustomStepView view) {
        super(PmcCustomStepDTO.class, view, i18n.tr("PMC Custom"), i18n.tr("Next"), ThemeColor.contrast4);
    }
