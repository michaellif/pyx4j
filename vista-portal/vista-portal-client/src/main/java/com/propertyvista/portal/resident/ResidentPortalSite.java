...
import com.propertyvista.portal.resident.themes.ResidentPortalPalette;
import com.propertyvista.portal.resident.themes.ResidentPortalTheme;
import com.propertyvista.portal.resident.ui.PortalRootPane;
    ...
    private void initSiteTheme() {
        siteThemeServices.retrieveSiteDescriptor(new DefaultAsyncCallback<SiteDefinitionsDTO>() {
            ...
            public void onSuccess(SiteDefinitionsDTO descriptor) {
                hideLoadingIndicator();
                StyleManager.installTheme(new ResidentPortalTheme(descriptor.skin().getValue()), new ResidentPortalPalette());
