...
public class CommunityEventPageActivity extends AbstractEditorActivity<CommunityEvent> implements CommunityEventPagePresenter {

    public CommunityEventPageActivity(AppPlace place) {
        super(CommunityEventPageView.class, GWT.<CommunityEventCrudService> create(CommunityEventCrudService.class), place);
    }
