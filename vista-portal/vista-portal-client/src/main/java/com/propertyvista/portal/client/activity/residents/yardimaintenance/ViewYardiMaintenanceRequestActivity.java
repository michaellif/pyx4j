...
public class ViewYardiMaintenanceRequestActivity extends SecurityAwareActivity implements EditYardiMaintenanceRequestView.Presenter {
    ...
    public ViewYardiMaintenanceRequestActivity(AppPlace place) {
