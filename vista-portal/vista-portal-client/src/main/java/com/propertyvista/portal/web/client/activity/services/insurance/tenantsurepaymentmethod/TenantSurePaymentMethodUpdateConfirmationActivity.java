...
import com.propertyvista.portal.web.client.ui.services.insurance.tenantsurepaymentmethod.TenantSurePaymentMethodUpdateConfirmationView;
...
public class TenantSurePaymentMethodUpdateConfirmationActivity extends SecurityAwareActivity implements
    ...
    public TenantSurePaymentMethodUpdateConfirmationActivity(AppPlace place) {
        this.view = PortalWebSite.getViewFactory().instantiate(TenantSurePaymentMethodUpdateConfirmationView.class);
