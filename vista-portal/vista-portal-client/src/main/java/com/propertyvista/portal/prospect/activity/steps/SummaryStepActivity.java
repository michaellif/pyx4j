...
public class SummaryStepActivity extends AbstractProspectWizardStepActivity<SummaryStepDTO> {
    ...
    public SummaryStepActivity(AppPlace place) {
        super(SummaryStepView.class, GWT.<SummaryStepService> create(SummaryStepService.class));
    }

    @Override
    public void navigateToNextStep() {
        AppSite.getPlaceController().goTo(new ProspectPortalSiteMap.Application.PaymentStep());
    }
