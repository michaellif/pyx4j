...
public class OptionsStepActivity extends AbstractProspectWizardStepActivity<OptionsStepDTO> {
    ...
    public OptionsStepActivity(AppPlace place) {
        super(OptionsStepView.class, GWT.<OptionsStepService> create(OptionsStepService.class));
    }
    ...
    public void navigateToPreviousStep() {
        AppSite.getPlaceController().goTo(new ProspectPortalSiteMap.Application.UnitStep());
    }
