...
public class ViewYardiMaintenanceRequestViewImpl extends ViewImpl<YardiServiceRequestDTO> implements ViewYardiMaintenanceRequestView {

    public ViewYardiMaintenanceRequestViewImpl() {
    ...
    public void populate(YardiServiceRequestDTO value) {
        ...
        // TODO : decide when disable editing if necessary 
        boolean editable = true;
        getEdit().setVisible(editable);
