...
import com.propertyvista.portal.shared.ui.communication.CommunicationPageView;
import com.propertyvista.portal.shared.ui.communication.CommunicationPageView.MessagePagePresenter;

public class CommunicationPageActivity extends AbstractEditorActivity<CommunicationThreadDTO> implements MessagePagePresenter {

    public CommunicationPageActivity(AppPlace place) {
        super(CommunicationPageView.class, GWT.<CommunicationPortalCrudService> create(CommunicationPortalCrudService.class), place);
    }
    ...
    public void saveMessageItem(AsyncCallback<MessageDTO> callback, MessageDTO message) {
        ...
        ((CommunicationPortalCrudService) getService()).saveChildMessage(callback, message);
    }

    @Override
    public void hideThread() {
        ((CommunicationPortalCrudService) getService()).hideThread(new DefaultAsyncCallback<VoidSerializable>() {
            @Override
