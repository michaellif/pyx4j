...
import com.propertyvista.portal.resident.ui.NotificationHeaderView;
import com.propertyvista.portal.resident.ui.NotificationHeaderView.NotificationHeaderPresenter;
...
//        notifications.add(new Notification("Confirm Message goes here", NotificationType.CONFIRM, "Confirm Notification"));
    ...
    public NotificationHeaderActivity(Place place) {
        view = ResidentPortalSite.getViewFactory().instantiate(NotificationHeaderView.class);
