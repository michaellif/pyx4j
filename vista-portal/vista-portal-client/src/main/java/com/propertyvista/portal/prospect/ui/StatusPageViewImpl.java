...
public class StatusPageViewImpl extends AbstractEditorView<ApplicationStatusDTO> implements StatusPageView {

    public StatusPageViewImpl() {
        setForm(new StatusPage(this));
    }
