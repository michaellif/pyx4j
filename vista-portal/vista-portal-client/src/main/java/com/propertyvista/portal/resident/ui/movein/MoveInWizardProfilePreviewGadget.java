...
public class MoveInWizardProfilePreviewGadget extends AbstractGadget<MoveInWizardStepPreviewView> {

    private static final I18n i18n = I18n.get(NewTenantWelcomeGadget.class);

    public MoveInWizardProfilePreviewGadget(MoveInWizardStepPreviewView view) {
        super(view, null, i18n.tr("Keep you profile updated"), ThemeColor.contrast2, 1);
        setActionsToolbar(new MoveInWizardLeaseSigningPreviewToolbar());

        setContent(new HTML("Keep you profile updated Explanantion"));
    }
    ...
    class MoveInWizardLeaseSigningPreviewToolbar extends GadgetToolbar {
        ...
        public MoveInWizardLeaseSigningPreviewToolbar() {
            ...
            Button continueButton = new Button(i18n.tr("Update your profile"), new Command() {
                @Override
                public void execute() {
