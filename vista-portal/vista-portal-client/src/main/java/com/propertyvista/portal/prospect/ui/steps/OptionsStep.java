...
public class OptionsStep extends CPortalEntityWizardStep<OptionsStepDTO> {
    ...
    private OptionsStepPresenter presenter;

    public OptionsStep(OptionsStepView view) {
        super(OptionsStepDTO.class, view, i18n.tr("Lease Options"), i18n.tr("Next"), ThemeColor.contrast4);
    }
