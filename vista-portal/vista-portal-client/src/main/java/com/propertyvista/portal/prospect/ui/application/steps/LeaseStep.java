...
import com.propertyvista.portal.shared.ui.util.folders.AdjustmentFolder;
...
public class LeaseStep extends ApplicationWizardStep {
    ...
    public IsWidget createStepContent() {
        ...
        formPanel.append(Location.Left, proto().unit().info().legalAddress(), new CEntityLabel<LegalAddress>()).decorate();
