...
import com.propertyvista.portal.prospect.ui.application.RentDetailsView;
import com.propertyvista.portal.rpc.portal.prospect.ProspectPortalSiteMap.Application;

public class RentDetailsActivityMapper implements ActivityMapper {

    public RentDetailsActivityMapper() {
    }

    @Override
    public Activity getActivity(Place place) {
        if (place instanceof Application) {
            return new RentalSummaryActivity(place, ProspectPortalSite.getViewFactory().getView(RentDetailsView.class));
        } else {
            return null;
        }
    }
