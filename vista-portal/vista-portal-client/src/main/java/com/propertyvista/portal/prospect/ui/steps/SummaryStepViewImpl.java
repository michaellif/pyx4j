...
public class SummaryStepViewImpl extends AbstractWizardStepView<SummaryStepDTO> implements SummaryStepView {

    private static final I18n i18n = I18n.get(SummaryStepViewImpl.class);

    public SummaryStepViewImpl() {
        super();
        setWizardStep(new SummaryStep(this));
    }
