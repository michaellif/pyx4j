...
import static com.propertyvista.portal.client.ui.residents.insurancemockup.components.Utils.asBigDecimals;
...
import com.propertyvista.portal.client.ui.residents.insurancemockup.components.FormattableCombo;
import com.propertyvista.portal.client.ui.residents.insurancemockup.components.MoneyLabeledCombo;
import com.propertyvista.portal.client.ui.residents.insurancemockup.components.MultiDisclosurePanel;
...
public class InsurancePurchaseEditorForm extends CEntityDecoratableForm<PurchaseInsuranceDTO> {
    ...
    public IsWidget createContent() {
        ...
        content.getColumnFormatter().setWidth(0, "90%");
        content.getColumnFormatter().setWidth(1, "10%");

        coverageTerms = new FormFlexPanel();
        coverageTerms.setWidth("100%");
...
//        insuranceTerms.setH1(++irow, 0, 1, i18n.tr("Coverage"));
        ...
        coverageTerms.setH2(++irow, 0, 1, i18n.tr("Total"));
        quoteTotalPanel = new VerticalPanel();
        coverageTerms.setWidget(++irow, 0, quoteTotalPanel);
