...
public class TenantSureQuoteViewerSimple extends CEntityViewer<TenantSureQuoteDTO> {

    @Override
    public IsWidget createContent(TenantSureQuoteDTO value) {
        Label label = new Label();
        label.setText(value.totalMonthlyPayable().getMeta().getCaption() + ": " + value.totalMonthlyPayable().getStringView());
        return label;
    }
