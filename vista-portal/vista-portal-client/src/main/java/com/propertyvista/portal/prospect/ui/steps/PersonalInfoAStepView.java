...
public interface PersonalInfoAStepView extends IWizardStepView<PersonalInfoAStepDTO> {

    interface PersonalInfoAStepPresenter extends IWizardStepPresenter<PersonalInfoAStepDTO> {
