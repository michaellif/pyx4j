...
public interface CommunicationPageView extends IEditorView<CommunicationThreadDTO> {

    public interface MessagePagePresenter extends IEditorPresenter<CommunicationThreadDTO> {
