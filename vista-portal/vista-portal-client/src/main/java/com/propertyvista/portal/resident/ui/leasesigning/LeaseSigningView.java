...
public interface LeaseSigningView extends IEditorView<LeaseAgreementDTO> {

    public interface LeaseSigningPresenter extends IEditorPresenter<LeaseAgreementDTO> {
