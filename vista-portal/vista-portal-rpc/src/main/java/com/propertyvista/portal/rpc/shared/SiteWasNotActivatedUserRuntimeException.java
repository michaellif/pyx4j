 ...
 */
public class SiteWasNotActivatedUserRuntimeException extends ContainerHandledUserRuntimeException {

    private static final long serialVersionUID = 1L;

    public SiteWasNotActivatedUserRuntimeException(String message) {
        super(message);
    }
}
