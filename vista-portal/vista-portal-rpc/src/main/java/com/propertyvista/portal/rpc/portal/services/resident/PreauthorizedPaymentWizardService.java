...
public interface PreauthorizedPaymentWizardService extends AbstractCrudService<PreauthorizedPaymentDTO> {
    ...
    void preview(AsyncCallback<AutopayAgreement> callback, PreauthorizedPaymentDTO currentValue);
}
