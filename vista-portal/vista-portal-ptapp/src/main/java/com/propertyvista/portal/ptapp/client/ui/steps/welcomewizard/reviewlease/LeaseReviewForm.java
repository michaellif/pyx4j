...
public class LeaseReviewForm extends CEntityDecoratableEditor<LeaseReviewDTO> {
    ...
    private final static I18n i18n = I18n.get(LeaseReviewForm.class);
    ...
    private final boolean viewMode = true;
    ...
    public IsWidget createContent() {
        ...
        // TODO ask someone if we need this for the demo
...
//        main.setWidget(++row, 0, inject(proto().tenantsWithInfo(), createTenantView()));
        ...
        main.setWidget(++row, 0, inject(proto().leaseTerms(), new LeaseTemsFolder(true)));
