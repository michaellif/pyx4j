...
public class TenantSureConfirmationForm extends CEntityForm<PaymentRecordDTO> {
    ...
    public TenantSureConfirmationForm(AbstractEntityView<PaymentRecordDTO> view) {
    ...
    private Widget createAutoPaySignupPanel() {
        ...
        text.add(new Anchor(i18n.tr("Sign up for Auto Pay today"), new Command() {
            @Override
            public void execute() {
                ((TenantSureConfirmationView.Presenter) view.getPresenter()).goToAutoPay();
            }
        }));
