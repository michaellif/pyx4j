...
public interface UploadSertificateWizardView extends IWizardView<InsuranceGeneric> {

    public interface UploadSertificateWizardPresenter extends WizardPresenter<InsuranceGeneric> {
