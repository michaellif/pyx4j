...
public class AbstractViewerView<E extends IEntity> extends AbstractPortalPanel implements IFormView<E> {

    protected static final I18n i18n = I18n.get(AbstractViewerView.class);
