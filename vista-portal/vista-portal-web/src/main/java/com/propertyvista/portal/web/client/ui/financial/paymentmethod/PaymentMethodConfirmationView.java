...
public interface PaymentMethodConfirmationView extends IEntityViewerView<PaymentMethodDTO> {

    interface Presenter extends IEntityViewerView.EntityPresenter<PaymentMethodDTO> {
