...
public interface TenantSurePurchaseWizardView extends IWizardView<TenantSurePurchaseRequestDTO> {

    interface Presenter extends WizardPresenter<TenantSurePurchaseRequestDTO> {
