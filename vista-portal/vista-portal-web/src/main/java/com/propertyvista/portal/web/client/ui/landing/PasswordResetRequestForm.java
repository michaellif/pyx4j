...
public class PasswordResetRequestForm extends CEntityForm<PasswordRetrievalRequest> {

    private static final I18n i18n = I18n.get(PasswordResetRequestForm.class);

    private final Command onSubmitCommand;

    private final HTML passwordResetFailedMessage;

    public PasswordResetRequestForm(Command onSubmitCommand) {
