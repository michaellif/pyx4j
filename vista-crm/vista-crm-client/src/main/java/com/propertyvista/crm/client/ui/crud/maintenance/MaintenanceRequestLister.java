...
public class MaintenanceRequestLister extends ListerBase<MaintenanceRequestDTO> {
    ...
    public static ColumnDescriptor[] createColumnDescriptors() {
        ...
        return new ColumnDescriptor[] {// @formatter:off
                ...
                new MemberColumnDescriptor.Builder(proto.tenant().leaseCustomer().customer().person().name()).searchable(false).build(),
                new MemberColumnDescriptor.Builder(proto.tenant().leaseCustomer().customer().person().name().firstName(), false).build(),
                new MemberColumnDescriptor.Builder(proto.tenant().leaseCustomer().customer().person().name().lastName(), false).build(),
