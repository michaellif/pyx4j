...
public class ChargeCodeEditorForm extends CrmEntityForm<ChargeCode> {

    public ChargeCodeEditorForm() {
        this(false);
    }

    public ChargeCodeEditorForm(boolean viewMode) {
        super(ChargeCode.class, viewMode);
    }
    ...
    public IsWidget createContent() {
        ...
        main.setWidget(++row, 0, inject(proto().taxes(), new ChargeCodeTaxFolder(isEditable())));
