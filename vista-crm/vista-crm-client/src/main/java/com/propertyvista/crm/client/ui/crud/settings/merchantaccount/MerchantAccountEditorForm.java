...
public class MerchantAccountEditorForm extends CrmEntityForm<MerchantAccount> {

    private static final I18n i18n = I18n.get(MerchantAccountEditorForm.class);

    public MerchantAccountEditorForm() {
        this(false);
    }

    public MerchantAccountEditorForm(boolean viewMode) {
