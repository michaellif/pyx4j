...
import com.propertyvista.crm.client.ui.crud.administration.website.content.gadgets.HomePageGadgetViewer;
...
public class HomePageGadgetViewerActivity extends CrmViewerActivity<HomePageGadget> implements HomePageGadgetViewer.Presenter {
    ...
    public HomePageGadgetViewerActivity(CrudAppPlace place) {
        super(HomePageGadget.class, place, CrmSite.getViewFactory().getView(HomePageGadgetViewer.class), GWT
                .<HomePageGadgetCrudService> create(HomePageGadgetCrudService.class));
    }
