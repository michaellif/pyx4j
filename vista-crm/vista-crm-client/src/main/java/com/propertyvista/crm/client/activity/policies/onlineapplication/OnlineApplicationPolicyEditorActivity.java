...
import com.propertyvista.crm.client.ui.crud.policies.onlineapplication.OnlineApplicationPolicyEditorView;
...
public class OnlineApplicationPolicyEditorActivity extends PolicyEditorActivityBase<OnlineApplicationPolicyDTO> {

    public OnlineApplicationPolicyEditorActivity(CrudAppPlace place) {
        super(place, CrmSite.getViewFactory().getView(OnlineApplicationPolicyEditorView.class), GWT
