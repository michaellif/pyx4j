...
public abstract class CustomerSelectionDialog extends EntitySelectorTableDialog<Customer> {
    ...
    protected List<ColumnDescriptor> defineColumnDescriptors() {
        return Arrays.asList(//@formatter:off
                ...
                new ColumnDescriptor.Builder(proto().person().name().firstName()).searchableOnly().filterAlwaysShown(true).build(),
                new ColumnDescriptor.Builder(proto().person().name().lastName()).searchableOnly().filterAlwaysShown(true).build(),
                ...
                new ColumnDescriptor.Builder(proto().person().email()).filterAlwaysShown(true).build(),
