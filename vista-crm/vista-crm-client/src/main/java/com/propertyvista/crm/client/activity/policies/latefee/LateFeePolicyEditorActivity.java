...
public class LateFeePolicyEditorActivity extends EditorActivityBase<LateFeePolicyDTO> {

    public LateFeePolicyEditorActivity(Place place) {
        super(place, PolicyViewFactory.instance(LateFeePolicyEditorView.class), GWT.<LateFeePolicyCrudService> create(LateFeePolicyCrudService.class),
