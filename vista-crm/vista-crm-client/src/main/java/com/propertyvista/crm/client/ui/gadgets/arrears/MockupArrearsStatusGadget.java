...
import com.propertyvista.domain.dashboard.gadgets.type.MockupArrearsStatusGadgetMeta;
import com.propertyvista.domain.dashboard.gadgets.type.GadgetMetadata;

public class MockupArrearsStatusGadget extends AbstractGadget<MockupArrearsStatusGadgetMeta> {

    private static final I18n i18n = I18n.get(MockupArrearsStatusGadget.class);

    private static class MockupArrearsStatusGadgetInstance extends ListerGadgetInstanceBase<MockupArrearsState, MockupArrearsStatusGadgetMeta> implements

    IBuildingBoardGadgetInstance {

        private static final I18n i18n = I18n.get(MockupArrearsStatusGadgetInstance.class);
        ...
        public MockupArrearsStatusGadgetInstance(GadgetMetadata gmd) {
            super(gmd, MockupArrearsState.class, MockupArrearsStatusGadgetMeta.class);
            service = GWT.create(MockupArrearsReportService.class);
        }

        @Override
        protected MockupArrearsStatusGadgetMeta createDefaultSettings(Class<MockupArrearsStatusGadgetMeta> metadataClass) {
            MockupArrearsStatusGadgetMeta metadata = super.createDefaultSettings(metadataClass);
            metadata.category().setValue(MockupArrearsStatusGadgetMeta.Category.Total);
            return metadata;
        }
        ...
        public Widget initContentPanel() {
            ...
            panel.setH1(0, 0, 1, (getMetadata().category().getValue() != null ? getMetadata().category().getValue() : MockupArrearsStatusGadgetMeta.Category.Total).toString());
        ...
        public ISetup getSetup() {
            return new SetupForm(new CEntityDecoratableForm<MockupArrearsStatusGadgetMeta>(MockupArrearsStatusGadgetMeta.class) {
                @Override
    ...
    public MockupArrearsStatusGadget() {
        super(MockupArrearsStatusGadgetMeta.class);
    }
    ...
    @Override
    protected GadgetInstanceBase<MockupArrearsStatusGadgetMeta> createInstance(GadgetMetadata gadgetMetadata) throws Error {
        return new MockupArrearsStatusGadgetInstance(gadgetMetadata);
    }
