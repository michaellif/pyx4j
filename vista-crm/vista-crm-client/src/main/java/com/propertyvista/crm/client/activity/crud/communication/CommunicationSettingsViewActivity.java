...
public class CommunicationSettingsViewActivity extends CrmViewerActivity<MessageCategory> implements CommunicationGroupViewerView.Presenter {
    public CommunicationSettingsViewActivity(CrudAppPlace place) {

        super(place, CrmSite.getViewFactory().getView(CommunicationGroupViewerView.class), (AbstractCrudService<MessageCategory>) GWT
