 ...
 * @version $Id$
 */
package com.propertyvista.crm.client.codegen;
...
public class GadgetFactoryGenerator extends Generator {
    ...
    private List<Class<? extends GadgetInstanceBase<?>>> getGadgetImplClasses(TreeLogger logger, JPackage jpackage) throws UnableToCompleteException {
        if (false) {
    ...
    public String generate(TreeLogger logger, GeneratorContext context, String typeName) throws UnableToCompleteException {
        ...
        try {
            ...
            JPackage gadgetsPackage = context.getTypeOracle().getPackage(_GadgetPackageMarker.class.getPackage().getName());

            logger.log(Type.INFO, "generating gadget factory for the following gadgets: " + getGadgetImplClasses(logger, gadgetsPackage).toString());
            ...
            if (pw != null) {
                ...
                for (Class<? extends GadgetInstanceBase<?>> klass : getGadgetImplClasses(logger, gadgetsPackage)) {
                ...
                for (Class<? extends GadgetInstanceBase<?>> gadgetClass : getGadgetImplClasses(logger, gadgetsPackage)) {
