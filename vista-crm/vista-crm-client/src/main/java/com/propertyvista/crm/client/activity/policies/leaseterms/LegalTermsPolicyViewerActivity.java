...
public class LegalTermsPolicyViewerActivity extends CrmViewerActivity<LegalTermsPolicyDTO> implements LegalTermsPolicyViewerView.IPrimeViewerPresenter {

    public LegalTermsPolicyViewerActivity(CrudAppPlace place) {
        super(LegalTermsPolicyDTO.class, place, CrmSite.getViewFactory().getView(LegalTermsPolicyViewerView.class), GWT
