...
public class EmployeeForm extends CrmEntityForm<EmployeeDTO> {
    ...
    public EmployeeForm(IPrimeFormView<EmployeeDTO, ?> view) {
    ...
    private IsWidget createPrivilegesTab() {
        ...
        buildingsAccessPanel.append(Location.Dual, proto().buildingAccess(), new BuildingFolder(isEditable()));
    ...
    private class NotificationFolder extends VistaBoxFolder<Notification> {
        ...
        private class NotificationEditor extends CForm<Notification> {
            ...
            protected IsWidget createContent() {
                ...
                formPanel.append(Location.Dual, proto().buildings(), new BuildingFolder(EmployeeForm.this.isEditable()));
