...
import com.propertyvista.crm.client.ui.tools.legal.n4.N4DownloadToolView;
...
public class N4DownloadToolActivity extends AbstractBulkOperationToolActivity<N4DownloadSettingsDTO, LegalNoticeCandidateDTO, Vector<N4LegalLetter>> implements
    ...
    public N4DownloadToolActivity(AppPlace place) {
        super(place, CrmSite.getViewFactory().getView(N4DownloadToolView.class), GWT.<N4DownloadToolService> create(N4DownloadToolService.class),
