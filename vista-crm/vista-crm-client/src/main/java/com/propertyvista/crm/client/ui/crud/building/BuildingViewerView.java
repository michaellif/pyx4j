...
public interface BuildingViewerView extends IPrimeViewerView<BuildingDTO> {

    public interface BuildingViewerPresenter extends BuildingPresenterCommon, IPrimeViewerView.IPrimeViewerPresenter {
