...
import com.propertyvista.crm.client.ui.crud.lease.common.LeaseViewerViewImplBase2;
...
public class LeaseViewerViewImpl2 extends LeaseViewerViewImplBase2<LeaseDTO2> implements LeaseViewerView2 {
    ...
    @Override
    public void populate(LeaseDTO2 value) {
    ...
    private abstract class TermLeaseBox extends OkCancelDialog {
        ...
        private CEntityDecoratableForm<LeaseDTO2> content;
        ...
        protected Widget createBody() {
            ...
            content = new CEntityDecoratableForm<LeaseDTO2>(LeaseDTO2.class) {
                @Override
