...
public class CreditCheckActivity extends AbstractActivity {
    ...
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        GWT.<CreditCheckStatusService> create(CreditCheckStatusService.class).obtainStatus(new DefaultAsyncCallback<CreditCheckStatusDTO>() {

            @Override
            public void onSuccess(CreditCheckStatusDTO result) {
                if (result == null) {
