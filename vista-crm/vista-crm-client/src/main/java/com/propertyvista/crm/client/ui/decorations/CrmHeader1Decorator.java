...
public class CrmHeader1Decorator extends VistaHeaderDecorator {

    public static String DEFAULT_STYLE_PREFIX = "vista_CrmHeader1Decorator";

    public CrmHeader1Decorator(String caption, Widget widget, String width) {
        super(caption, widget, width);
        setStyleName(DEFAULT_STYLE_PREFIX);
    }

    public CrmHeader1Decorator(String caption, Widget widget) {
        this(caption, widget, null);
    }

    public CrmHeader1Decorator(String caption, String width) {
        this(caption, null, width);
    }

    public CrmHeader1Decorator(String caption) {
        this(caption, (String) null);
    }

    public CrmHeader1Decorator(IObject<?> member, String width) {
        this(member.getMeta().getCaption(), null, width);
    }

    public CrmHeader1Decorator(IObject<?> member) {
        this(member, null);
    }
