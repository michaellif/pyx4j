...
public class BuildingLister extends AbstractLister<BuildingDTO> {
    ...
    public BuildingLister() {
        ...
        setColumnDescriptors(//@formatter:off
            ...
            new MemberColumnDescriptor.Builder(proto().info().address().addressLine1(), false).build(),
            new MemberColumnDescriptor.Builder(proto().info().address().addressLine2(), false).build(),
