...
public class ParkingRentEditorForm extends CrmEntityForm<ParkingRent> {

    public ParkingRentEditorForm(IView<ParkingRent> parentView) {
        this(new CrmEditorsComponentFactory(), parentView);
    }

    public ParkingRentEditorForm(IEditableComponentFactory factory, IView<ParkingRent> parentView) {
