...
public class OtherArrearsListerGadget extends ArrearsListerGadget {

    public OtherArrearsListerGadget(GadgetMetadata gmd) {
        super(gmd);
    }
    ...
    protected void selfInit(GadgetMetadata gmd) {
        ...
        gmd.name().setValue(GadgetType.OtherArrearsGadget.toString());
    }
