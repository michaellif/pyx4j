...
public class IdAssignmentPolicyEditorForm extends PolicyDTOTabPanelBasedEditorForm<IdAssignmentPolicyDTO> {
    ...
    private final static I18n i18n = I18n.get(IdAssignmentPolicyEditorForm.class);

    public IdAssignmentPolicyEditorForm() {
        this(false);
    }

    public IdAssignmentPolicyEditorForm(boolean viewMode) {
