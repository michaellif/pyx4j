...
public class LineChartGadget extends GadgetInstanceBase<com.propertyvista.domain.dashboard.gadgets.type.demo.LineChartGadgetMetadata> {

    private SimplePanel panel;

    public LineChartGadget(LineChartGadgetMetadata gmd) {
