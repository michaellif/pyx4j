...
public class CreditCheckWizardForm extends WizardForm<BuildingDTO> {

    private static final I18n i18n = I18n.get(CreditCheckWizardForm.class);

    public CreditCheckWizardForm() {
        super(BuildingDTO.class, VistaTheme.defaultTabHeight);
    }
...
//        }
    ...
    private class PropertyPhoneFolder extends VistaTableFolder<PropertyPhone> {
        ...
        public PropertyPhoneFolder() {
            super(PropertyPhone.class, CreditCheckWizardForm.this.isEditable());
        }
    ...
    private class PropertyContactFolder extends VistaTableFolder<PropertyContact> {
        ...
        public PropertyContactFolder() {
            super(PropertyContact.class, CreditCheckWizardForm.this.isEditable());
        }
    ...
    private class BuildingAmenityFolder extends VistaTableFolder<BuildingAmenity> {
        ...
        public BuildingAmenityFolder() {
            super(BuildingAmenity.class, CreditCheckWizardForm.this.isEditable());
        }
