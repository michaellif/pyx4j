...
public class ChargeCodeEditorActivity extends EditorActivityBase<ChargeCode> {

    public ChargeCodeEditorActivity(Place place) {
        super(place,

        SettingsViewFactory.instance(ChargeCodeEditorView.class),

        GWT.<AbstractCrudService<ChargeCode>> create(ChargeCodeCrudService.class),
