...
public interface CreditCheckWizardView extends IPrimeWizardView<CreditCheckSetupDTO>, IsView {

    interface Presenter extends IPrimeWizardView.IPrimeWizardPresenter {
    }
