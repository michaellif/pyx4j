...
public class PADPolicyEditorActivity extends PolicyEditorActivityBase<PADPolicyDTO> {

    public PADPolicyEditorActivity(CrudAppPlace place) {
        super(place, PolicyViewFactory.instance(PADPolicyEditorView.class), GWT.<PADPolicyCrudService> create(PADPolicyCrudService.class), PADPolicyDTO.class);
    }
}
