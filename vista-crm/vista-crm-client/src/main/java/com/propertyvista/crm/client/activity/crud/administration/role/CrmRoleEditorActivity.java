...
import com.propertyvista.crm.client.ui.crud.administration.role.CrmRoleEditorView;
...
public class CrmRoleEditorActivity extends CrmEditorActivity<CrmRole> {
    ...
    public CrmRoleEditorActivity(CrudAppPlace place) {
        super(CrmRole.class,  place, CrmSite.getViewFactory().getView(CrmRoleEditorView.class), GWT.<AbstractCrudService<CrmRole>> create(CrmRoleCrudService.class));
    }
}
