...
public class ChargeCodeListerActivity extends ListerActivityBase<ChargeCode> {

    public ChargeCodeListerActivity(Place place) {
        super(place,

        SettingsViewFactory.instance(ChargeCodeListerView.class),

        GWT.<AbstractListService<ChargeCode>> create(ChargeCodeCrudService.class),
