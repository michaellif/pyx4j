...
public class BillableItemFolder2 extends VistaBoxFolder<BillableItem> {

    private static final I18n i18n = I18n.get(BillableItemFolder2.class);

    public BillableItemFolder2() {
