...
public class PieChart2DGadget extends GadgetInstanceBase<com.propertyvista.domain.dashboard.gadgets.type.demo.PieChart2DGadgetMetadata> {

    private SimplePanel panel;

    public PieChart2DGadget(PieChart2DGadgetMetadata gmd) {
