...
public interface PmcPaymentMethodsEditorView extends IPrimeEditorView<PmcPaymentMethodsDTO> {

    public interface Presenter extends IPrimeEditorView.IPrimeEditorPresenter {
    }
