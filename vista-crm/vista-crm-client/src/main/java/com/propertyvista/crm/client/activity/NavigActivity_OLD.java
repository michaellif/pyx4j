...
public class NavigActivity_OLD extends AbstractActivity implements NavigView_OLD.MainNavigPresenter, BoardUpdateHandler {

    private static final I18n i18n = I18n.get(NavigActivity_OLD.class);
    ...
    public NavigActivity_OLD(Place place) {
