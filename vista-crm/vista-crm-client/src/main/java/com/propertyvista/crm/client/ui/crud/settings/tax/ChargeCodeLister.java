...
public class ChargeCodeLister extends ListerBase<ChargeCode> {

    private static final I18n i18n = I18n.get(ChargeCodeLister.class);

    public ChargeCodeLister() {
        super(ChargeCode.class, CrmSiteMap.Settings.ChargeCode.class, false, true);
        ...
        addActionItem(new Button(i18n.tr("Delete Checked"), new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                for (ChargeCode item : getDataTablePanel().getDataTable().getCheckedItems()) {
