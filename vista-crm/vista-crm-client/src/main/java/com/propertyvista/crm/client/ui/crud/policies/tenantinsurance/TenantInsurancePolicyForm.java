        ...
        get(proto().minimumRequiredLiability()).addValueValidator(new EditableValueValidator<BigDecimal>() {
            ...
            public FieldValidationError isValid(CComponent<BigDecimal> component, BigDecimal value) {
                ...
                if (value != null && value.compareTo(MAX_FLOOR) > 0) {
                    return new FieldValidationError(component, i18n.tr("The maximum of minimum required liability is ${0,number,#,##0.00}", MAX_FLOOR));
                }
                if (value != null && value.compareTo(BigDecimal.ZERO) < 0) {
                    return new FieldValidationError(component, i18n.tr("Please provide a non-negative value"));
                } else {
                    return null;
                }
            }
