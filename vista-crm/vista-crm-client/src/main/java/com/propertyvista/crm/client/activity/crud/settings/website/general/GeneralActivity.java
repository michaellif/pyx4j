 ...
 * @version $Id$
 */
package com.propertyvista.crm.client.activity.crud.settings.website.general;
...
public class GeneralActivity extends AbstractActivity {

    private final CrudAppPlace place;

    public GeneralActivity(Place place) {
    ...
    public void start(AcceptsOneWidget container, EventBus eventBus) {
        GWT.<SiteGeneralCrudService> create(SiteGeneralCrudService.class).retrieveHomeItem(new AsyncCallback<Key>() {
            @Override
