...
public class ApplicationStatusFolder extends VistaBoxFolder<OnlineApplicationStatus> {
    ...
    @Override
    public IFolderItemDecorator<OnlineApplicationStatus> createItemDecorator() {
        VistaBoxFolderItemDecorator<OnlineApplicationStatus> decor = (VistaBoxFolderItemDecorator<OnlineApplicationStatus>) super.createItemDecorator();
