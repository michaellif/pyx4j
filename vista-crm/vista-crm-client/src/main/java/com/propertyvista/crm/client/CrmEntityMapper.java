...
public class CrmEntityMapper {
    ...
    public static void init() {
        ...
        AppPlaceEntityMapper.register(FinancialTermsPolicy.class, Administration.Policies.FinancialTerms.class, defaultImage);
        ...
        AppPlaceEntityMapper.register(ResidentPortalPolicy.class, Administration.Policies.ResidentPortal.class, defaultImage);
