...
public class LeaseLister extends ListerBase<Lease> {
    ...
    protected void fillDefaultColumnDescriptors(List<ColumnDescriptor<Lease>> columnDescriptors, Lease proto) {
        ...
        columnDescriptors.add(ColumnDescriptorFactory.createColumnDescriptor(proto, proto.leaseFromDate()));
        columnDescriptors.add(ColumnDescriptorFactory.createColumnDescriptor(proto, proto.leaseToDate()));
    }
}
