...
public class YardiInterfacePolicyListerActivity extends AbstractPrimeListerActivity<YardiInterfacePolicyDTO> {

    public YardiInterfacePolicyListerActivity(AppPlace place) {
