...
public class CreateAccountViewImpl extends FlowPanel implements CreateAccountView {
    ...
    public CreateAccountViewImpl() {
        ...
        //        HTML requirements = new HTML(CrmResources.INSTANCE.requirements().getText());
        //        requirements.getElement().getStyle().setPaddingLeft(95, Unit.PX);
        //        requirements.getElement().getStyle().setPaddingBottom(45, Unit.PX);
        //
        //        requirements.getElement().getStyle().setProperty("background", "url(" + CrmResources.INSTANCE.requirements().getURL() + ") no-repeat");
        //        leftColumn.add(requirements);
        //
        //        HTML time = new HTML(CrmResources.INSTANCE.time().getText());
        //        time.getElement().getStyle().setPaddingLeft(95, Unit.PX);
        //        time.getElement().getStyle().setPaddingBottom(45, Unit.PX);
        //
        //        time.getElement().getStyle().setProperty("background", "url(" + CrmResources.INSTANCE.time().getURL() + ") no-repeat");
        //        leftColumn.add(time);
        //
        //        HTML dontWorry = new HTML(CrmResources.INSTANCE.dontWorry().getText());
        //        dontWorry.getElement().getStyle().setPaddingLeft(95, Unit.PX);
        //        dontWorry.getElement().getStyle().setPaddingBottom(45, Unit.PX);
        //
        //        dontWorry.getElement().getStyle().setProperty("background", "url(" + CrmResources.INSTANCE.dontWorry().getURL() + ") no-repeat");
