...
public class ProductDictionaryViewImpl extends CrmViewerViewImplBase<ARCode> implements ProductDictionaryView {
    ...
    public ProductDictionaryViewImpl() {
        ...
        productCodeLister = new ListerInternalViewImplBase<ARCode>(new ProductCodeLister());
