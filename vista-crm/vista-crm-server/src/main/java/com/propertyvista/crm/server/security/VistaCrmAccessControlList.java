...
// - Tenant-related:
        ...
        grant(VistaBasicBehavior.CRM, new EntityPermission(Lease2.class, EntityPermission.ALL));
...
//        }
        ...
        grant(VistaDataAccessBehavior.BuildingsAssigned, new Lease2DatasetAccessRule(), Lease2.class);
