...
public class SelectLeaseTermListServiceImpl extends AbstractListServiceImpl<LeaseTerm> implements SelectLeaseTermListService {

    public SelectLeaseTermListServiceImpl() {
