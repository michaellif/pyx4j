...
public class ARCodeCrudServiceImpl extends AbstractCrmCrudServiceImpl<ARCode, ARCode> implements ARCodeCrudService {
    ...
    @Override
    protected void create(ARCode bo, ARCode to) {
        bo.reserved().setValue(false);
        super.create(bo, to);
    }
