...
public class ChargeCodeCrudServiceImpl extends AbstractCrudServiceImpl<ChargeCode> implements ChargeCodeCrudService {

    public ChargeCodeCrudServiceImpl() {
        super(ChargeCode.class);
    }
}
