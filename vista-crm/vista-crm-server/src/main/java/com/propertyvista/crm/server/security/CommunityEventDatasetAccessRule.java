...
public class CommunityEventDatasetAccessRule implements DatasetAccessRule<CommunityEvent> {

    private static final long serialVersionUID = 1L;

    @Override
    public void applyRule(EntityQueryCriteria<CommunityEvent> criteria) {
