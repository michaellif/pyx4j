...
public class MerchantAccountCrudServiceImpl extends AbstractCrudServiceImpl<MerchantAccount> implements MerchantAccountCrudService {
    ...
    protected void setCalulatedFileds(MerchantAccount entity, MerchantAccount dto) {
    ...
    @Override
    protected void enhanceRetrieved(MerchantAccount entity, MerchantAccount dto) {
