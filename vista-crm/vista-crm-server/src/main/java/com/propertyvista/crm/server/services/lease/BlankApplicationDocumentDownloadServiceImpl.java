...
import com.propertyvista.server.common.lease.LeaseBlankApplicationDocumentCreationProcess;
...
public class BlankApplicationDocumentDownloadServiceImpl extends ReportServiceImpl<IEntity> implements BlankApplicationDocumentDownloadService {
    ...
    public void createDownload(AsyncCallback<String> callback, ReportRequest reportRequest) {
        ...
        callback.onSuccess(DeferredProcessRegistry.fork(new LeaseBlankApplicationDocumentCreationProcess(leaseId, customerId), ThreadPoolNames.DOWNLOADS));
    }
}
