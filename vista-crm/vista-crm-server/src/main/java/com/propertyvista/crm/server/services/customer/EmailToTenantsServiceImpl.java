...
public class EmailToTenantsServiceImpl implements EmailToTenantsService {
    ...
    public void sendEmail(AsyncCallback<String> callback, EmailTemplateType emailType,
        ...
        callback.onSuccess(DeferredProcessRegistry.fork(new EmailToTenantsDeferredProcess(emailType, criteria), ThreadPoolNames.DOWNLOADS));
