...
public class N4LeaseGenerationDeferredProcess extends AbstractDeferredProcess {

    private static final Logger log = LoggerFactory.getLogger(N4LeaseGenerationDeferredProcess.class);
    ...
    public N4LeaseGenerationDeferredProcess(EvictionCase evictionCase) {
    ...
    public void execute() {
        try {
            ServerSideFactory.create(N4ManagementFacade.class).issueN4(evictionCase, monitor);
