...
class VistaCrmSupportAccessControlList extends UIAclBuilder {
    ...
    VistaCrmSupportAccessControlList() {
        ...
        grant(VistaBasicBehavior.PropertyVistaSupport, new ActionPermission(PadFileUpload.class));
        grant(VistaBasicBehavior.PropertyVistaSupport, new ActionPermission(PadFileDownload.class));
    }
