...
public class SelectCustomerListServiceImpl extends AbstractListServiceImpl<Customer> implements SelectCustomerListService {

    public SelectCustomerListServiceImpl() {
