...
public class SiteBrandingCrudServiceImpl extends AbstractCrudServiceDtoImpl<SiteDescriptor, SiteDescriptorDTO> implements SiteBrandingCrudService {

    public SiteBrandingCrudServiceImpl() {
