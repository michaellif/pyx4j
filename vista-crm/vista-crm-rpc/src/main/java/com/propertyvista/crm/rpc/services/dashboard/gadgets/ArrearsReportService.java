...
public interface ArrearsReportService extends IService {
     ...
     */
    void arrearsList(AsyncCallback<EntitySearchResult<MockupArrearsCompilation>> callback, Vector<Key> buildingPKs, LogicalDate when, Vector<Sort> sortingCriteria,
