...
//        style.addProperty("background", "url(images/menu_active.png) no-repeat scroll left center transparent");
        ...
        style.addProperty("color", "#5D466B");
        ...
        style = new Style(".", StyleName.VistaPmsiteStaticPage.name(), " .", StyleName.SecondaryNavig.name(), " ul li a:hover span");
        style.addProperty("border-bottom", "1px solid #5D466B");
        addStyle(style);

        style = new Style(".", StyleName.VistaPmsiteStaticPage.name(), " .", StyleName.SecondaryNavig.name(), " ul li.active a span");
        style.addProperty("border-bottom", "2px solid #5D466B");
        addStyle(style);
        ...
        style.addProperty("background-color", "#FFFFFF !important");
        addStyle(style);
