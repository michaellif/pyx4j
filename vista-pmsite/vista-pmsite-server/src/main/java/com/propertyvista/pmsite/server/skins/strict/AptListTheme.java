...
public class AptListTheme extends DefaultAptListTheme {
    ...
    protected void initCommonStyle() {
        ...
        style = new Style(".", StyleName.VistaPmsiteAptListPage.name(), " .", StyleName.SecondaryNavig.name());
        ...
        style = new Style(".", StyleName.VistaPmsiteAptListPage.name(), " .", StyleName.VistaPmsiteMain.name(), " .", StyleName.Caption2.name());
        style.addProperty("height", "60px");
        style.addProperty("background", "none repeat scroll 0 0 #6B547A");
        style.addProperty("border-bottom", "1px solid #DCD2E1");
        addStyle(style);
        ...
        style.addProperty("color", "#CABDD3");
//        style.addProperty("background-image", "url("images/aptListIcons.png")");
    ...
    protected void initSecondaryNavig() {
        ...
        style = new Style(".", StyleName.AdvancedSearchNarrowWrap.name(), " .", StyleName.SearchTypeSelButton.name(), " .", StyleName.TypeselActive.name());
        style.addProperty("color", "#767676 !important");
        ...
        style.addProperty("color", "#484848");
        addStyle(style);
    ...
    protected void initApartmentListingWrap() {
        ...
        Style style = new Style(".", StyleName.ApartmentListingWrap.name());
        style.addProperty("background", "none repeat scroll 0 0 #FFFFFF");
        style.addProperty("border-left", "1px solid #D1D1D1");
        addStyle(style);

        style = new Style(".", StyleName.ListingMapview.name());
        ...
        style.addProperty("background-color", "#EEE9D8");
        addStyle(style);
...
//      style.addProperty("background-image", "url("images/map_for_rockville.png")");
        addStyle(style);
...
//    style.addProperty("background-image", "url("images/details_for_rockville.png")");
