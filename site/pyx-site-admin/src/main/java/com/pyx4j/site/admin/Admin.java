...
public class Admin implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        pageEditor.setWidth("100%");
        final RichTextToolbar tb = new RichTextToolbar(pageEditor);
        tb.setWidth("100%");

        VerticalPanel htmlEditor = new VerticalPanel();
        htmlEditor.add(tb);
        htmlEditor.add(pageEditor);
