...
public class ValueAdapterDate extends ValueAdapterPrimitive {

    protected ValueAdapterDate(Dialect dialect) {
        super(dialect, java.sql.Date.class);
    }
    ...
    public int bindValue(PreparedStatement stmt, int parameterIndex, IEntity entity, MemberOperationsMeta member) throws SQLException {
        ...
        if (value == null) {
            ...
            stmt.setDate(parameterIndex, new java.sql.Date(c.getTimeInMillis()));
        }
        return 1;
    }
