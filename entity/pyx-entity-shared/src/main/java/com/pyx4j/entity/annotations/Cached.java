...
public @interface Cached {
    ...
    /**
     * Number of seconds after which the cached copy should be expired; the default value
     * -1 "keep as long as possible".
     */
    int expirationSeconds() default -1;

    /**
     * Cache the results of Query on server.
     */
    boolean cacheQuery() default false;

    Class<? extends CacheAdapter<?>> adapter() default CacheAlwaysAdapter.class;
}
