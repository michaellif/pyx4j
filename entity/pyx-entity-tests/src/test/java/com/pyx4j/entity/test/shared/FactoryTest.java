...
public class FactoryTest extends InitializerTestCase {
    ...
    public void testSetManipulations() {
        ...
        employee3.setPrimaryKey(new Key(2));
        ...
        employee2.setPrimaryKey(new Key(22));
        employee3.setPrimaryKey(new Key(22));
