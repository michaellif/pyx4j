...
public class UtilityView extends AbstractView {

    public UtilityView(String tabTitle) {
        super(RiaEntityImageBundle.INSTANCE.image(), false);
