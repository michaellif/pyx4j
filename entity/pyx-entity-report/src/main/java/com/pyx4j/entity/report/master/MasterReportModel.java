...
public class MasterReportModel extends JasperReportModel {
    ...
    public MasterReportModel(List<ReportEntry> subreports) {
        this(subreports, null);
    }

    public MasterReportModel(List<ReportEntry> subreports, Map<String, Object> parameters) {
        super(REPORT_NAME, subreports, parameters);
    }
}
