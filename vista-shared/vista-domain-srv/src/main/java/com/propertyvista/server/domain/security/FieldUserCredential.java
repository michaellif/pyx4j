...
@RpcBlacklist
@Table(primaryKeyStrategy = Table.PrimaryKeyStrategy.ASSIGNED, expands = FieldUser.class)
@I18n(strategy = I18n.I18nStrategy.IgnoreAll)
public interface FieldUserCredential extends AbstractUserCredential<FieldUser> {
