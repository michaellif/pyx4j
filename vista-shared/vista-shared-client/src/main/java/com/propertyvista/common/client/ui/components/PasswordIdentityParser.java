...
public class PasswordIdentityParser implements IParser<PasswordIdentity> {

    private final CPersonalIdentityField<PasswordIdentity> component;

    public PasswordIdentityParser(CPersonalIdentityField<PasswordIdentity> component) {
        super();
