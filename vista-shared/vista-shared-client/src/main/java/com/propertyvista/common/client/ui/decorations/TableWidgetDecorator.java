...
import com.propertyvista.common.client.ui.decorations.TableWidgetDecorator.Builder.Alignment;
import com.propertyvista.common.client.ui.decorations.TableWidgetDecorator.Builder.LabelPosition;

public class TableWidgetDecorator extends FlowPanel implements IDecorator<CComponent<?>> {
    ...
    public TableWidgetDecorator(CComponent<?> component) {
        this(new Builder(component));
    }

    protected TableWidgetDecorator(final Builder builder) {
