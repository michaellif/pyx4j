...
public abstract class AbstractIdentificationDocumentUploadServiceImpl extends AbstractUploadServiceImpl<IEntity, IdentificationDocumentBlob> {

    private static final I18n i18n = I18n.get(AbstractIdentificationDocumentUploadServiceImpl.class);
    ...
    public AbstractIdentificationDocumentUploadServiceImpl() {
    }
    ...
    public long getMaxSize() {
        return EntityFactory.getEntityPrototype(IdentificationDocumentBlob.class).data().getMeta().getLength();
    }
    ...
    @Override
    protected void processUploadedData(IEntity uploadInitiationData, UploadedData uploadedData, IFile<IdentificationDocumentBlob> response) {
