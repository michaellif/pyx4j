...
public class ArrearsGadgetMetadataDefaultSettings extends GadgetMetadataCommonDefaultSettings<ArrearsGadgetMetadata> {

    @Override
    public void init(ArrearsGadgetMetadata gadgetMetadata) {
