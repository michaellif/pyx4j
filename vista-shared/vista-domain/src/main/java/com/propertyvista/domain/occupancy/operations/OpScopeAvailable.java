...
public class OpScopeAvailable extends AbstractAptUnitOccupancyOperation {

    public OpScopeAvailable() {
        // for GWT serialization
        this(null, null);
    }

    public OpScopeAvailable(LogicalDate applyStartDate, Vector<Vector<AptUnitOccupancySegment>> appliedTo) {
    ...
    public void populateSelector(IAptUnitOccupancyOperationSelector selector) {
        selector.populateOpScopeAvaialble(this);
    }
