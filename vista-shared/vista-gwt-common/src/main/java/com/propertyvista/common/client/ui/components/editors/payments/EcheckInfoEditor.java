...
public class EcheckInfoEditor extends CEntityDecoratableEditor<EcheckInfo> {
    ...
    public IsWidget createContent() {
        ...
        int row = -1;
        panel.setH3(++row, 0, 1, i18n.tr("EcheckInfo Data"));

        panel.setWidget(++row, 0, new DecoratorBuilder(inject(proto().nameOnAccount()), 30).build());
        ...
        panel.setWidget(++row, 0, new DecoratorBuilder(inject(proto().routingNo()), 20).build());
        panel.setWidget(++row, 0, new DecoratorBuilder(inject(proto().accountNo()), 20).build());
        panel.setWidget(++row, 0, new DecoratorBuilder(inject(proto().checkNo()), 20).build());
