    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (enabled) {
            ...
            if (devSession.getAttribute(ACCESS_GRANTED_ATTRIBUTE) == Boolean.TRUE) {
                ...
                if (servletPath.startsWith("/o/") || servletPath.startsWith("/public/") || servletPath.endsWith("/crm/debug/")
                        || servletPath.endsWith("/ptapp/debug/") || servletPath.endsWith("/debug/") || servletPath.equals("/favicon.ico")) {
                    chain.doFilter(request, response);
