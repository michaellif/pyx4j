...
public class OnboardingUserEditorForm extends AdminEntityForm<OnboardingUserDTO> {

    private final static I18n i18n = I18n.get(OnboardingUserEditorForm.class);

    public OnboardingUserEditorForm(boolean viewMode) {
        super(OnboardingUserDTO.class, viewMode);
    }

    public OnboardingUserEditorForm() {
