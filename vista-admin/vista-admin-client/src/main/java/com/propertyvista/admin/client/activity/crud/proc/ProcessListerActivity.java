...
public class ProcessListerActivity extends ListerActivityBase<Process> {

    @SuppressWarnings("unchecked")
    public ProcessListerActivity(Place place) {
        super(place, ManagementVeiwFactory.instance(ProcessListerView.class), (AbstractCrudService<Process>) GWT
                .create(ProcessCrudService.class), Process.class);
