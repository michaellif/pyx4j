...
public class AdminSiteAppPlaceDispatcher extends AbstractAppPlaceDispatcher {
    ...
    private static final I18n i18n = I18n.get(AdminSiteAppPlaceDispatcher.class);

    @Override
    protected void obtainDefaulPublicPlace(AsyncCallback<AppPlace> callback) {
        callback.onSuccess(new AdminSiteMap.Login());
    }
    ...
    protected void obtainDefaultAuthenticatedPlace(AsyncCallback<AppPlace> callback) {
        callback.onSuccess(new AdminSiteMap.Management());
    }
