...
public class AdminHeader2Decorator extends VistaHeaderDecorator {
    ...
    public AdminHeader2Decorator(String caption, Widget widget, String width) {
        super(caption, widget, width);
        setStyleName(DEFAULT_STYLE_PREFIX);
    }

    public AdminHeader2Decorator(String caption, Widget widget) {
        this(caption, widget, null);
    }

    public AdminHeader2Decorator(String caption, String width) {
        this(caption, null, width);
    }

    public AdminHeader2Decorator(String caption) {
        this(caption, (String) null);
    }

    public AdminHeader2Decorator(IObject<?> member, String width) {
        this(member.getMeta().getCaption(), null, width);
    }

    public AdminHeader2Decorator(IObject<?> member) {
        this(member, null);
    }
