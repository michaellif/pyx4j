...
public class TermsAndConditionsEditorViewImpl extends AdminEditorViewImplBase<TermsAndConditions> implements TermsAndConditionsEditorView {

    public TermsAndConditionsEditorViewImpl() {
        super(AdminSiteMap.Legal.Terms.class);
        setForm(new TermsAndConditionsForm(false));
    }
}
