 ...
 * @version $Id$
 */
package com.propertyvista.admin.client.ui.dashboard;
...
public class DashboardViewImpl extends SimplePanel implements DashboardView {
    ...
    public DashboardViewImpl() {
        ...
        main.add(new AdminHeaderDecorator(i18n.tr("Dashboard"), layouts));
    ...
    private class LayoutsSet extends HorizontalPanel {
        ...
        private void setDefaultImages() {
            layout1.setResource(AdminImages.INSTANCE.dashboardLayout1_0());
            layout12.setResource(AdminImages.INSTANCE.dashboardLayout12_0());
            layout21.setResource(AdminImages.INSTANCE.dashboardLayout21_0());
            layout22.setResource(AdminImages.INSTANCE.dashboardLayout22_0());
            layout3.setResource(AdminImages.INSTANCE.dashboardLayout3_0());
        }
    }
}
