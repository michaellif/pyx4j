...
public class EmailTemplateManagerTest extends VistaDBTestBase {
    ...
    public static synchronized void createPmc() {
        ...
        PmcCompanyInfo info = EntityFactory.create(PmcCompanyInfo.class);
        info.companyName().setValue(NamespaceManager.getNamespace());
        Persistence.service().persist(info);
    }
    ...
    public void testTemplates() {
        ...
        {
            type = EmailTemplateType.ApplicationApproved;
...
//            throw new Error("Template Type not implemented");
    ...
    public void loadDomain() {
        ...
        mApp.leaseApplication().set(lease.leaseApplication());
