 ...
 * @author ArtyomB
 */
package com.propertyvista.biz.legal.forms.n4cp;
...
public class N4CPFieldsMapping extends LtbFormFieldsMapping<N4CPFormFieldsData> {

    public N4CPFieldsMapping() {
        super(N4CPFormFieldsData.class);
    }
