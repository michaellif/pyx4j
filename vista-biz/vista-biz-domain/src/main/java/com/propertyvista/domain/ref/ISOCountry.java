...
public enum ISOCountry {
    ...
    AlandIslands("Aland Islands", "AX", "ALA", "248"), //
    ...
    Antigua("Antigua and Barbuda", "AG", "ATG", "028"), //
    ...
    BosniaHerzegovina("Bosnia and Herzegovina", "BA", "BIH", "070"), //
    Botswana("Botswana", "BW", "BWA", "072"), //
    BouvetIsland("Bouvet Island", "BV", "BVT", "074"), //
    Brazil("Brazil", "BR", "BRA", "076"), //
    BruneiDarussalam("Brunei Darussalam", "BN", "BRN", "096"), //
    Bulgaria("Bulgaria", "BG", "BGR", "100"), //
    BurkinaFaso("Burkina Faso", "BF", "BFA", "854"), //
    Burundi("Burundi", "BI", "BDI", "108"), //
    CaboVerde("Cabo Verde", "CV", "CPV", "132"), //
    ...
    CocosIslands("Cocos Islands", "CC", "CCK", "166"), //
    ...
    FrenchTerritories("French Southern Territories", "TF", "ATF", "260"), //
    ...
    HeardIslands("Heard and McDonald Islands", "HM", "HMD", "334"), //
    Vatican("Vatican City State", "VA", "VAT", "336"), //
    ...
    NorthKorea("North Korea", "KP", "PRK", "408"), //
    SouthKorea("South Korea", "KR", "KOR", "410"), //
    Kuwait("Kuwait", "KW", "KWT", "414"), //
    Kyrgyzstan("Kyrgyzstan", "KG", "KGZ", "417"), //
    LaoRepublic("Lao People's Democratic Republic", "LA", "LAO", "418"), //
    ...
    Palestine("Palestine", "PS", "PSE", "275"), //
    ...
    SaintBarthelemy("Saint Barthélemy", "BL", "BLM", "652"), //
    SaintHelena("Saint Helena, Ascension and Tristan da Cunha", "SH", "SHN", "654"), //
    SaintKitts("Saint Kitts and Nevis", "KN", "KNA", "659"), //
    SaintLucia("Saint Lucia", "LC", "LCA", "662"), //
    SaintMartin("Saint Martin", "MF", "MAF", "663"), //
    SaintPierre("Saint Pierre and Miquelon", "PM", "SPM", "666"), //
    SaintVincent("Saint Vincent and the Grenadines", "VC", "VCT", "670"), //
    Samoa("Samoa", "WS", "WSM", "882"), //
    SanMarino("San Marino", "SM", "SMR", "674"), //
    SaoTome("Sao Tome and Principe", "ST", "STP", "678"), //
    ...
    SintMaartenDutch("Sint Maarten Dutch", "SX", "SXM", "534"), //
    ...
    VirginIslandsGB("Virgin Islands GB", "VG", "VGB", "092"), //
    VirginIslands("Virgin Islands", "VI", "VIR", "850"), //
    WallisFutuna("Wallis and Futuna", "WF", "WLF", "876"), //
    WesternSahara("Western Sahara", "EH", "ESH", "732"), //
    ...
    public final String isoNum;

    private ISOCountry(String name, String code2, String code3, String num) {
        this.name = name;
        this.iso2 = code2;
        this.iso3 = code3;
        this.isoNum = num;
    ...
    public static ISOCountry forName(String name) {
        if (name != null) {
