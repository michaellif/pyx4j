...
class EFTBankMockAck implements ScheduledResponseAckTransaction.Handler, ScheduledResponseAckMerchant.Handler {
    ...
    FundsTransferAckFile createAcknowledgementFile(FundsTransferFile unacknowledgedFile) {
        FundsTransferAckFile ackFile = EntityFactory.create(FundsTransferAckFile.class);
