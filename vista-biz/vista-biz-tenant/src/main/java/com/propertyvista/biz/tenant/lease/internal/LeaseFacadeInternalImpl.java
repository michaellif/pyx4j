...
public class LeaseFacadeInternalImpl implements LeaseFacade {
    ...
    public void requestForMoreInformation(Lease leaseId, Employee decidedBy, String decisionReason) {
        new LeaseInternalManager().requestForMoreInformation(leaseId, decidedBy, decisionReason);
    }
    ...
    public void close(Lease leaseId, Employee decidedBy, String decisionReason) {
        new LeaseInternalManager().close(leaseId, decidedBy, decisionReason);
    }
    ...
    public Building getLeaseBuilding(Lease leaseId) {
        return new LeaseInternalManager().getLeaseBuilding(leaseId);
    }
}
