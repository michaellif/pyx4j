...
class FirstBillingManager extends AbstractBillingManager {

    private static final I18n i18n = I18n.get(FirstBillingManager.class);

    FirstBillingManager(Bill bill) {
