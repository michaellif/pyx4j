...
class ARInternalArrearsManager extends ARArrearsManager {
    ...
    private static class SingletonHolder {
        public static final ARInternalArrearsManager INSTANCE = new ARInternalArrearsManager();
    }

    static ARInternalArrearsManager getInstance() {
        return SingletonHolder.INSTANCE;
    }

    private LeaseArrearsSnapshot createArrearsSnapshot(InternalBillingAccount billingAccount) {
        ...
        arrearsSnapshot.totalAgingBuckets().set(addInPlace(createAgingBuckets(DebitType.total), arrearsSnapshot.agingBuckets()));
    ...
    private BuildingArrearsSnapshot createArrearsSnapshot(Building building) {
    ...
    void updateArrearsHistory(InternalBillingAccount billingAccount) {
    ...
    @Override
    protected Collection<AgingBuckets> getAgingBuckets(BillingAccount billingAccount) {
