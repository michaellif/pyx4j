...
class ZeroCycleBillingManager extends AbstractBillingManager {

    private static final I18n i18n = I18n.get(ZeroCycleBillingManager.class);

    ZeroCycleBillingManager(Bill bill) {
