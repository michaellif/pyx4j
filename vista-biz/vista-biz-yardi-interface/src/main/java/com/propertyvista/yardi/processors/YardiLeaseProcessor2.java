...
public class YardiLeaseProcessor2 {

    private final static boolean useDatesToCalculateLeaseStatus = false;

    private final static Logger log = LoggerFactory.getLogger(YardiLeaseProcessor2.class);

    private final YardiResidentTransactionsData rtd;

    public YardiLeaseProcessor2(YardiResidentTransactionsData rtd) {
        this.rtd = rtd;
    }
