...
public class CompositeDebugId implements IDebugId {
    ...
    public CompositeDebugId(IDebugId parent, IDebugId child, int itemNumber) {
        this(parent, new CompositeDebugId(child, new StringDebugId(String.valueOf(itemNumber))));
    }

    public CompositeDebugId(IDebugId parent, String child, int itemNumber) {
        this(parent, new StringDebugId(child + DEBUGID_SEPARATOR + itemNumber));
    }
    ...
    public CompositeDebugId(String parent, String child) {
        this(new StringDebugId(parent), new StringDebugId(child));
    }
    ...
    public String debugId() {
        return (parent != null ? parent.debugId() + DEBUGID_SEPARATOR : "") + (child != null ? child.debugId() : "unknown");
    }
